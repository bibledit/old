...
/*
Generates lists of keys that can be used to access Bibledit's project configuration.
*/


#define PRJ_S "<!-- Project Configuration Start -->"
#define PRJ_E "<!-- Project Configuration End -->"
...
{
  // Filenames.
  string genconfigfilename = "../../src/projectconfig.cpp";
  string htmlfilename = "scripting_configuration.html";

  // Load the source code of the project configuration.
