...
echo $ cd
echo $ wget --continue http://bibledit.org/linux/bibledit-1.0.202.tar.gz
cd
wget --continue http://bibledit.org/linux/bibledit-1.0.202.tar.gz
if [ $? -ne 0 ]
then
...
$ mkdir -p bibledit
$ tar xf bibledit-1.0.202.tar.gz -C bibledit --strip-components=1
mkdir -p bibledit
tar xf bibledit-1.0.202.tar.gz -C bibledit --strip-components=1
if [ $? -ne 0 ]
then
