...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <ol>
    ...
    <li><em>{t}Take your own data.{/t}</em> {t}Taking your own data means that your data is taken as it is, and that this is copied to the repository, overwriting whatever is there in the repository now.{/t} <a href="collaboration_take_yourself.php?object={$object}&directory={$directory}">{t}Take your data.{/t}</a></li>
  </ol> 
