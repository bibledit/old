...
class Filter_Diff
{
  ...
  */
  public function produceUsfmChapterLevel ($bibleIdentifier, $directory)
  {
    ...
    $biblename = $database_bibles->getName ($bibleIdentifier);
    
    $old_ch_usfm = array ();
    $new_ch_usfm = array ();
    $old_ch_usfm [] = "<h1>$biblename</h1>";
    $new_ch_usfm [] = "<h1>$biblename</h1>";
  ...
  */
  public function produceUsfmVerseLevel ($bibleIdentifier, $directory)
  {
    ...
    $old_vs_usfm = array ();
    $new_vs_usfm = array ();
    $old_vs_usfm [] = "<h1>$biblename</h1>";
    $new_vs_usfm [] = "<h1>$biblename</h1>";
