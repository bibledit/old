...
<p><a href="002ubuntu1010.php">{t}Version 0.2 on Ubuntu 10.10 desktop and server.{/t}</a></p>
<p><a href="002ubuntu1004.php">{t}Version 0.2 on Ubuntu 10.04 desktop and server.{/t}</a></p>
...
<h2>{t}Login{/t}</h2>
<p>{t}To log into the application, use the default username "adminusername" and password "adminpassword". These only work if no Administrator's  account exist on the system. It is recommended, therefore, to create an Administrator's account of your own choice, and then to remove the default adminusername account.{/t}</p>
