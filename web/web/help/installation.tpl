...
<p><a href="newubuntu1010.php">{t}Version 0.4 and higher on Ubuntu 10.10 desktop and server.{/t}</a></p>
<p><a href="oldubuntu1004.php">{t}Version 0.3 on Ubuntu 10.04 desktop and server.{/t}</a></p>
