...
<p>{t}If you'd like to install your own version of Bibledit-Web, this is possible too.{/t}</p>
<p>{t}No installable packages have been created yet. But you can clone the source code from the git repository.{/t}</p>
