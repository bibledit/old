...
<td style="color:red">{$username_or_email_invalid_message}</td>
</tr>

<tr>
<td align="right">{t}Password{/t}</td>
<td><input type="password" name="pass" maxlength="30" /></td>
<td style="color:red">{$password_invalid_message}</td>
</tr>
...
<p>{t}Forgot password?{/t}</p>

<p>{t}Not registered? Sign up!{/t}</p>
</form>
