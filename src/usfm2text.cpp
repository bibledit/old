...
Usfm2Text::Usfm2Text(Text2Pdf * text2pdf_in, bool show_progress)
  {
    ...
    if (show_progress)
      {
        ...
        progress_event_id
            = g_timeout_add_full(G_PRIORITY_DEFAULT, 500, GSourceFunc (signal_progress_timeout), gpointer(this), NULL);
      }
    cancel = false;
    ...
    add_style(font_family_size_line_height_style(),
...
void Usfm2Text::add_usfm_code(const ustring& line)
// Add some usfm code to the object's usfm input buffer.
  {
    usfm_code.push_back(line);
  }

void Usfm2Text::preprocess()
        ...
        while (!usfm_line.empty())
          {
            ...
            marker_found = usfm_search_marker(usfm_line, marker,
                    ...
                    if (is_opener)
                      {
                        Usfm2XslFoStyle * stylepointer =
                            marker_get_pointer_to_style(marker);
                        if (stylepointer)
                          {
                            ...
                            case u2xtIdentifierBook:
                              {
                                ...
                                ustring id_line =
                                    get_erase_code_till_next_marker(usfm_line,
                            ...
                            case u2xtIdentifierLongTOC:
                              {
                                toc_collect_text(usfm_line, marker_length,
                                    true, book);
                                processed = true;
                                break;
                              }
                                ...
                                if (!endnote_dump_marker_encountered)
                                  {
                                    add_style(
                                        ...
                                        u2xtDumpEndnotes);
                                    endnote_position
                                        = stylepointer->endnote_position_type;
                            ...
                            case u2xtPublishedChapterMarker:
                              {
                                ...
                                ustring label =
                                    get_erase_code_till_next_marker(usfm_line,
                                        0, marker_length, true);
                                ChapterLabel publishedchaptermarker(book,
                                    chapter, label);
                    ...
                    if (stylepointer)
                      {
                        ...
                        case u2xtIdentifierBook:
                          {
                            ...
                            output_id_page_break(stylepointer, fo_block_style,
                                fo_inline_style);
                            book_spans_columns = (books_id_to_type(book)
                                == btFrontBackMatter);
                            break;
                          }
                        case u2xtIdentifierComment:
                          {
                            get_erase_code_till_next_marker(usfm_line,
                                marker_position, marker_length, true);
                            break;
                          }
                        case u2xtIdentifierRunningHeader:
                          {
                            output_running_header(usfm_line, stylepointer,
                                marker_length, book);
                            break;
                          }
                        case u2xtIdentifierLongTOC:
                          {
                            toc_insert_referent(usfm_line, fo_block_style,
                        ...
                        case u2xtParagraphMainTitle:
                          {
                            output_text_starting_new_paragraph(usfm_line,
                                stylepointer, fo_block_style, fo_inline_style,
                                marker_length, true);
                            break;
                          }
                        case u2xtParagraphSubTitle:
                        ...
                        case u2xtInlineText:
                          {
                            output_text_character_style(usfm_line,
                                stylepointer, fo_block_style, fo_inline_style,
                        ...
                        case u2xtChapterNumber:
                          {
                            ...
                            output_chapter_number_try_normal(usfm_line,
                                stylepointer, fo_block_style, fo_inline_style,
                                marker_length, book);
                            break;
                          }
                        case u2xtVerseNumber:
                          {
                            ...
                            if (!verse_was_written)
                              {
                                while (!usfm_line.empty() && (usfm_line.substr(
                                    0, 1) == " "))
                                  {
                                    usfm_line.erase(0, 1);
                                  }
                        ...
                        case u2xtCrossreferenceStart:
                          {
                            output_text_note(usfm_line, stylepointer,
                                fo_block_style, marker_length, is_opener);
                            break;
                          }
                        case u2xtEndNoteStart:
                          {
                            buffer_endnote(usfm_line, stylepointer,
                                marker_length, is_opener);
                            break;
                          }
                        case u2xtFootEndNoteStandardContent:
                        ...
                        case u2xtTableOfContents:
                          {
                            toc_insert_body(usfm_line, fo_block_style,
                                fo_inline_style, marker_length);
                            break;
                          }
                        case u2xtPreface:
                        ...
                        case u2xtCover:
                          {
                            output_other_page_break(usfm_line, stylepointer,
                                fo_block_style, fo_inline_style, marker_length);
                            break;
                          }
                        case u2xtSpine:
                          {
                        ...
                        case u2xtPicture:
                          {
                            output_picture(usfm_line, stylepointer,
                                fo_block_style, fo_inline_style, marker_length);
                            break;
                          }
                        case u2xtPageBreak:
                        ...
                        case u2xtTableElementRow:
                          {
                            output_text_table(usfm_line, fo_block_style,
                                fo_inline_style, marker_length);
                            break;
                          }
                        case u2xtTableElementHeading:
                        ...
                        case u2xtElastic:
                          {
                            output_elastic(usfm_line, fo_block_style,
                                fo_inline_style, marker_length);
                            break;
                          }
                        case u2xtDumpEndnotes:
                          {
                            get_erase_code_till_next_marker(usfm_line, 0,
                                marker_length, false);
                        ...
                        case u2xtInsertion:
                          {
                            output_text_insertion_deletion(usfm_line,
                                stylepointer, fo_block_style, fo_inline_style,
                                marker_length, is_opener);
                            break;
                          }
                        ...
                        case u2xtLineSpacing:
                          {
                            output_spacing_paragraph(usfm_line, fo_block_style,
                                fo_inline_style, marker_length, is_opener);
                            break;
                          }
                        case u2xtKeepOnPage:
                          {
                            output_keep_on_page(usfm_line, fo_block_style,
                                fo_inline_style, marker_length, is_opener);
                            break;
                          }
                        case u2xtFontFamilySizeLineHeight:
                          {
                            output_font_family_size_line_height(usfm_line,
                                fo_block_style, fo_inline_style, marker_length,
                                is_opener);
                            break;
                          }
                        ...
                        case u2xtSubjectIndexEntry:
                          {
                            ...
                            if (!is_opener)
                              {
                                usfm_line.insert(0,
                                    stylepointer->wordlist_entry_addition);
                              }
                            break;
                          }
                        default:
...
void Usfm2Text::set_right_to_left()
  {
    right_to_left = true;
  }

void Usfm2Text::set_two_columns()
  {
    two_columns = true;
  }
...
void Usfm2Text::add_style(const ustring& marker_in, Usfm2XslFoStyleType type_in)
  {
...
void Usfm2Text::output_text_starting_new_paragraph(ustring& line,
    Usfm2XslFoStyle * stylepointer, Usfm2XslFoStyle * & fo_block_style,
    Usfm2XslFoStyle * & fo_inline_style, size_t marker_length,
...
Usfm2XslFoStyle * Usfm2Text::marker_get_pointer_to_style(const ustring& marker)
...
void Usfm2Text::open_paragraph(Usfm2XslFoStyle * style,
    bool keep_with_next_paragraph)
  {
    // Open the paragraph.
...
void Usfm2Text::set_paragraph(Usfm2XslFoStyle * style,
    bool keep_with_next_paragraph)
  {
    // Fontsize
...
void Usfm2Text::output_chapter_number_try_normal(ustring& line,
    Usfm2XslFoStyle * stylepointer, Usfm2XslFoStyle * & fo_block_style,
    Usfm2XslFoStyle * & fo_inline_style, size_t marker_length, unsigned int book)
    ...
    for (unsigned int i = 0; i < chapter_labels.size(); i++)
      {
        if (chapter_labels[i].book == book)
          {
            if ((chapter_labels[i].chapter == 0) || (chapter_labels[i].chapter
                == chapter))
              {
...
void Usfm2Text::output_chapter_number_try_at_first_verse(ustring line,
...
void Usfm2Text::output_running_header(ustring& line,
    Usfm2XslFoStyle * stylepointer, size_t marker_length, unsigned int book)
...
bool Usfm2Text::signal_progress_timeout(gpointer user_data)
  {
    ((Usfm2Text *) user_data)->signal_progress();
    return true;
  }

void Usfm2Text::signal_progress()
  {
    if (progresswindow)
      {
...
bool Usfm2Text::output_verse_number(Usfm2XslFoStyle * stylepointer,
...
void Usfm2Text::output_text_character_style(ustring& line,
    Usfm2XslFoStyle * stylepointer, Usfm2XslFoStyle * & fo_block_style,
...
void Usfm2Text::output_text_table(ustring& line,
    Usfm2XslFoStyle * & fo_block_style, Usfm2XslFoStyle * & fo_inline_style,
    size_t marker_length)
...
// the note caller objects from them.
  {
    for (unsigned int i = 0; i < styles.size(); i++)
      {
        if ((styles[i].type == u2xtFootNoteStart) || (styles[i].type
            == u2xtEndNoteStart) || (styles[i].type == u2xtCrossreferenceStart))
          {
            // Create the note caller.
            NoteCaller
                * notecaller =
                    new NoteCaller (styles[i].note_numbering_type, styles[i].note_numbering_user_sequence);
...
void Usfm2Text::destroy_note_callers()
// This function goes through all available styles, and then creates
// the note caller objects from them.
// Or it destroys them.
  {
...
void Usfm2Text::output_text_note(ustring& line, Usfm2XslFoStyle * stylepointer,
    Usfm2XslFoStyle * & fo_block_style, size_t marker_length, bool is_opener)
...
Usfm2XslFoStyle * Usfm2Text::get_default_paragraph_style_for_note(
    Usfm2XslFoStyle * notestyle)
...
// for a footnote, it returns the default paragraph style for this note.
  {
    ...
    for (unsigned int i = 0; i < styles.size(); i++)
      {
        if ((notestyle->type == u2xtFootNoteStart) || (notestyle->type
            == u2xtEndNoteStart))
          {
...
void Usfm2Text::note_callers_new_chapter()
...
void Usfm2Text::add_print_portion(unsigned int book_in,
    vector<unsigned int> chapters_from_in, const vector<ustring>& verses_from_in,
    vector<unsigned int> chapters_to_in, const vector <ustring>& verses_to_in)
// Adds a portion to be printed.
// If no portions was set, everything will be printed.
  {
    inrange.add_portion(book_in, chapters_from_in, verses_from_in,
        chapters_to_in, verses_to_in);
  }

void Usfm2Text::set_new_book(unsigned int book_in)
  {
    book = book_in;
    set_new_chapter(0);
...
void Usfm2Text::output_id_page_break(Usfm2XslFoStyle * stylepointer,
    Usfm2XslFoStyle * & fo_block_style, Usfm2XslFoStyle * & fo_inline_style)
...
void Usfm2Text::output_other_page_break(ustring& line,
    Usfm2XslFoStyle * stylepointer, Usfm2XslFoStyle * & fo_block_style,
    Usfm2XslFoStyle * & fo_inline_style, size_t marker_length)
...
void Usfm2Text::output_page_break(Usfm2XslFoStyle * & fo_block_style,
    Usfm2XslFoStyle * & fo_inline_style, bool oddpage)
// Outputs a page break.
  {
...
void Usfm2Text::output_picture(ustring& line, Usfm2XslFoStyle * stylepointer,
    Usfm2XslFoStyle * & fo_block_style, Usfm2XslFoStyle * & fo_inline_style,
    size_t marker_length)
// Prints a picture.
  {
...
void Usfm2Text::output_elastic(ustring& line,
    Usfm2XslFoStyle * & fo_block_style, Usfm2XslFoStyle * & fo_inline_style,
    size_t marker_length)
...
void Usfm2Text::toc_collect_text(ustring& line, size_t marker_length,
...
void Usfm2Text::toc_insert_referent(ustring& line,
    Usfm2XslFoStyle * & fo_block_style, Usfm2XslFoStyle * & fo_inline_style,
    size_t marker_length)
...
void Usfm2Text::toc_insert_body(ustring& line,
    Usfm2XslFoStyle * & fo_block_style, Usfm2XslFoStyle * & fo_inline_style,
    size_t marker_length)
...
void Usfm2Text::dump_endnotes(Usfm2XslFoStyle * & fo_block_style,
...
void Usfm2Text::buffer_endnote(ustring& line, Usfm2XslFoStyle * stylepointer,
...
void Usfm2Text::output_text_insertion_deletion(ustring& line,
    Usfm2XslFoStyle * stylepointer, Usfm2XslFoStyle * & fo_block_style,
    Usfm2XslFoStyle * & fo_inline_style, size_t marker_length, bool is_opener)
...
void Usfm2Text::no_space_before_or_after()
...
void Usfm2Text::output_spacing_paragraph(ustring& line,
    Usfm2XslFoStyle * & fo_block_style, Usfm2XslFoStyle * & fo_inline_style,
    size_t marker_length, bool is_opener)
  {
    // Erase the marker from the line.
...
void Usfm2Text::output_keep_on_page(ustring& line,
    Usfm2XslFoStyle * & fo_block_style, Usfm2XslFoStyle * & fo_inline_style,
    size_t marker_length, bool is_opener)
  {
    // Erase the marker from the line.
...
void Usfm2Text::no_new_page()
  {
    do_not_allow_new_page = true;
  }

void Usfm2Text::set_include_full_references_with_notes()
  {
    include_full_references_with_notes = true;
  }

void Usfm2Text::optionally_add_full_references(ustring& line,
    Usfm2XslFoStyle * stylepointer)
  {
