...
GotoReferenceDialog::GotoReferenceDialog (unsigned int currentbook,
                                          unsigned int currentchapter, 
                                          const ustring& currentverse):
  reference (0)
{
  // Init variables
  ...
  gtk_widget_add_accelerator (gotoreferencedialog, "activate_focus", accel_group,
  ...
  gtk_table_attach (GTK_TABLE (table1), label7, 2, 3, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table1), scrolledwindow3, 2, 3, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
