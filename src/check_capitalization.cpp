...
CheckCapitalization::CheckCapitalization (const ustring& project,
...
void CheckCapitalization::check_capitalization (vector<int>& chapters, vector<ustring>& verses,
...
void CheckCapitalization::get_chapter_and_verse (vector<int>& chapters, vector<ustring>& verses, 
