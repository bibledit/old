...
void NoteTemplate::start_element_handler (GMarkupParseContext *context,
...
void NoteTemplate::end_element_handler (GMarkupParseContext *context,
                                        const gchar         *element_name,
                                        gpointer             user_data,
                                        GError             **error)
{
...
void NoteTemplate::text_handler (GMarkupParseContext *context,
                                 const gchar         *text,
                                 gsize                text_len,
                                 gpointer             user_data,
                                 GError             **error)
...
void NoteTemplate::passthrough_handler    (GMarkupParseContext *context,
...
void NoteTemplate::error_handler          (GMarkupParseContext *context,
                                           GError              *error,
                                           gpointer             user_data)
{
  cerr << error->message << endl;
