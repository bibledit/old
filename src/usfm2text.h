...
#ifndef INCLUDED_USFM2TEXT_H
#define INCLUDED_USFM2TEXT_H
...
private:
  ...
  // Verse processing.
  void output_verse_number(Usfm2XslFoStyle * stylepointer, Usfm2XslFoStyle * & fo_block_style, Usfm2XslFoStyle * & fo_inline_style, size_t marker_length);
