...
GitSetupDialog::GitSetupDialog(int dummy)
{
  ...
  g_signal_connect((gpointer) checkbutton_remote, "toggled", G_CALLBACK(on_checkbutton_remote_toggled), gpointer(this));
  g_signal_connect((gpointer) entry_path, "changed", G_CALLBACK(on_entry_changed), gpointer(this));
  g_signal_connect((gpointer) button_copy, "clicked", G_CALLBACK(on_button_action_clicked), gpointer(this));
  g_signal_connect((gpointer) button_synchronize, "clicked", G_CALLBACK(on_button_action_clicked), gpointer(this));
