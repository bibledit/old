...
{
  cout << "create usfm view" << endl; // Todo
  /*
...
USFMView::~USFMView()
{
  cout << "destroy usfm view" << endl; // Todo
  /*
  // Save the chapter.
  chapter_save();
...
void USFMView::show_quick_references()
...
bool USFMView::show_quick_references_timeout(gpointer user_data)
{
  ((USFMView *) user_data)->show_quick_references_execute();
  return false;
}

void USFMView::show_quick_references_execute()
...
{
  ((USFMView *) user_data)->on_textview_cursor_moved_delayer(textview, step, count);
}

void USFMView::on_textview_cursor_moved_delayer(GtkTextView * textview, GtkMovementStep step, gint count)
{
...
bool USFMView::on_textview_cursor_moved_delayer_handler(gpointer user_data)
{
...
ustring USFMView::verse_number_get()
...
{
  ((USFMView *) user_data)->textview_grab_focus(widget);
}

void USFMView::textview_grab_focus(GtkWidget * widget)
{
  // Focus handling.
...
bool USFMView::on_grab_focus_delayer_timeout(gpointer data)
{
  ((USFMView *) data)->on_grab_focus_delayed_handler();
  return false;
}

void USFMView::on_grab_focus_delayed_handler()
/*
...
void USFMView::programmatically_grab_focus(GtkWidget * widget)
{
...
gboolean USFMView::on_text_motion_notify_event(GtkWidget * textview, GdkEventMotion * event, gpointer user_data)
{
  return ((USFMView *) user_data)->text_motion_notify_event(textview, event);
}

gboolean USFMView::text_motion_notify_event(GtkWidget * textview, GdkEventMotion * event)
...
void USFMView::on_text_event_after(GtkWidget * widget, GdkEvent * event, gpointer user_data)
{
  ((USFMView *) user_data)->text_event_after(widget, event);
}

void USFMView::text_event_after(GtkWidget * textview, GdkEvent * ev)
...
void USFMView::text_edit_if_link(GtkWidget * textview, GtkTextIter * iter)
...
gboolean USFMView::text_key_press_event_before(GtkWidget * widget, GdkEventKey * event, gpointer user_data)
{
  return ((USFMView *) user_data)->on_text_key_press_event_before(widget, event);
}

gboolean USFMView::on_text_key_press_event_before(GtkWidget * widget, GdkEventKey * event)
...
gboolean USFMView::text_key_press_event_after(GtkWidget * widget, GdkEventKey * event, gpointer user_data)
{
  return ((USFMView *) user_data)->on_text_key_press_event_after(widget, event);
}

gboolean USFMView::on_text_key_press_event_after(GtkWidget * widget, GdkEventKey * event)
// Postprocessing of the keyboard events in the text editors.
{
  return false;
}

void USFMView::on_textbuffer_footnotes_changed(GtkEditable * editable, gpointer user_data)
{
  ((USFMView *) user_data)->on_textbuffer_footnotes();
}

void USFMView::on_textbuffer_footnotes()
{
  if (record_undo_actions()) {
    show_quick_references();
  }
...
void USFMView::create_or_update_formatting_data()
...
void USFMView::create_or_update_text_style(Style * style, bool paragraph, bool plaintext, double font_multiplier)
/*
...
bool USFMView::load_text_not_starting_with_marker(GtkTextBuffer * textbuffer, ustring & line, ustring & paragraph_mark, ustring & character_mark, size_t marker_pos, size_t marker_length, bool marker_found)
/*
...
bool USFMView::load_text_starting_new_paragraph(GtkTextBuffer * textbuffer, ustring & line, ustring & paragraph_mark, ustring & character_mark, const ustring & marker, size_t marker_pos, size_t marker_length, bool is_opener, bool marker_found)
/*
...
bool USFMView::load_text_starting_character_style(GtkTextBuffer * textbuffer, ustring & line, ustring & paragraph_mark, ustring & character_mark, const ustring & marker, size_t marker_pos, size_t marker_length, bool is_opener, bool marker_found)
/*
...
bool USFMView::load_text_ending_character_style(GtkTextBuffer * textbuffer, ustring & line, ustring & paragraph_mark, ustring & character_mark, const ustring & marker, size_t marker_pos, size_t marker_length, bool is_opener, bool marker_found)
/*
...
bool USFMView::load_text_verse_number(ustring & line, ustring & paragraph_mark, ustring & character_mark, const ustring & marker, size_t marker_pos, size_t marker_length, bool is_opener, bool marker_found)
/*
...
bool USFMView::load_text_note_raw(ustring & line, const ustring & marker, size_t marker_pos, size_t marker_length, bool is_opener, bool marker_found)
/*
...
bool USFMView::load_text_table_raw(ustring & line, const ustring & paragraph_mark, const ustring & marker, size_t marker_pos, size_t marker_length, bool is_opener, bool marker_found)
...
bool USFMView::load_text_table_starting_row(ustring & line, EditorTable & editortable, GtkTextBuffer * &textbuffer, bool & row_zero_initialized, gint & row, gint & column, ustring & paragraph_mark, const ustring & marker, size_t marker_pos, size_t marker_length, bool is_opener, bool marker_found)
/*
...
bool USFMView::load_text_table_starting_cell(ustring & line, EditorTable & editortable, GtkTextBuffer * &textbuffer, bool & row_zero_initialized, gint & row, gint & column, ustring & paragraph_mark, const ustring & marker, size_t marker_pos, size_t marker_length, bool is_opener, bool marker_found)
...
bool USFMView::load_text_starting_footnote_content(GtkTextBuffer * textbuffer, ustring & line, ustring & paragraph_mark, ustring & character_mark, const ustring & marker, size_t marker_pos, size_t marker_length, bool is_opener, bool marker_found)
/*
...
bool USFMView::load_text_ending_footnote_content(GtkTextBuffer * textbuffer, ustring & line, ustring & paragraph_mark, ustring & character_mark, const ustring & marker, size_t marker_pos, size_t marker_length, bool is_opener, bool marker_found)
/*
...
void USFMView::load_text_with_unknown_markup(GtkTextBuffer * textbuffer, ustring & line, ustring & paragraph_mark, ustring & character_mark)
/*
...
void USFMView::load_text_ensure_normal_paragraph(ustring & line, ustring & paragraph_mark, ustring & character_mark)
/*
...
void USFMView::erase_related_note_bits()
{
...
void USFMView::display_notes_remainder(bool focus_rendered_textview)
/*
  ...
  for (unsigned int i = 0; i < editornotes.size(); i++) {
    ...
    while (!editornotes[i].rawtext.empty()) {
      ...
      if (load_text_not_starting_with_marker(editornotes[i].textbuffer, editornotes[i].rawtext, paragraph_mark, character_mark, marker_pos, marker_length, marker_found)) ;
        ...
        load_text_with_unknown_markup(editornotes[i].textbuffer, editornotes[i].rawtext, paragraph_mark, character_mark);
    }
...
void USFMView::renumber_and_clean_notes_callers()
...
void USFMView::display_table(ustring line, GtkTextIter iter)
...
void USFMView::on_related_widget_size_allocated(GtkWidget * widget, GtkAllocation * allocation, gpointer user_data)
{
  ((USFMView *) user_data)->related_widget_size_allocated(widget, allocation);
}

void USFMView::related_widget_size_allocated(GtkWidget * widget, GtkAllocation * allocation)
/*
...
void USFMView::set_embedded_note_textview_width(unsigned int notenumber)
...
void USFMView::set_embedded_note_caller_height(unsigned int notenumber)
...
void USFMView::set_embedded_table_textviews_width(unsigned int tablenumber)
// This sets the width of the textview that contains the text of a note.
{
...
void USFMView::on_buffer_insert_text_before(GtkTextBuffer * textbuffer, GtkTextIter * pos_iter, gchar * text, gint length, gpointer user_data)
{
  ((USFMView *) user_data)->buffer_insert_text_before(textbuffer, pos_iter, text, length);
}

void USFMView::buffer_insert_text_before(GtkTextBuffer * textbuffer, GtkTextIter * pos_iter, gchar * text, gint length)
{
...
void USFMView::on_buffer_insert_text_after(GtkTextBuffer * textbuffer, GtkTextIter * pos_iter, gchar * text, gint length, gpointer user_data)
{
  ((USFMView *) user_data)->buffer_insert_text_after(textbuffer, pos_iter, text, length);
}

void USFMView::buffer_insert_text_after(GtkTextBuffer * textbuffer, GtkTextIter * pos_iter, gchar * text, gint length)
{
...
void USFMView::on_buffer_delete_range_before(GtkTextBuffer * textbuffer, GtkTextIter * start, GtkTextIter * end, gpointer user_data)
{
  ((USFMView *) user_data)->buffer_delete_range_before(textbuffer, start, end);

}

void USFMView::buffer_delete_range_before(GtkTextBuffer * textbuffer, GtkTextIter * start, GtkTextIter * end)
{
...
void USFMView::on_buffer_delete_range_after(GtkTextBuffer * textbuffer, GtkTextIter * start, GtkTextIter * end, gpointer user_data)
{
  ((USFMView *) user_data)->buffer_delete_range_after(textbuffer, start, end);
}

void USFMView::buffer_delete_range_after(GtkTextBuffer * textbuffer, GtkTextIter * start, GtkTextIter * end)
{
  signal_editor_changed();
  process_text_child_anchors_deleted();
}

void USFMView::on_buffer_apply_tag(GtkTextBuffer * textbuffer, GtkTextTag * tag, GtkTextIter * startiter, GtkTextIter * enditer, gpointer user_data)
{
  ((USFMView *) user_data)->buffer_apply_tag(textbuffer, tag, startiter, enditer);
}

void USFMView::buffer_apply_tag(GtkTextBuffer * textbuffer, GtkTextTag * tag, GtkTextIter * startiter, GtkTextIter * enditer)
{
  // Only proceed if undo-able actions are to be recorded.
  if (record_undo_actions()) {
...
void USFMView::on_buffer_remove_tag(GtkTextBuffer * textbuffer, GtkTextTag * tag, GtkTextIter * startiter, GtkTextIter * enditer, gpointer user_data)
{
  ((USFMView *) user_data)->buffer_remove_tag(textbuffer, tag, startiter, enditer);
}

void USFMView::buffer_remove_tag(GtkTextBuffer * textbuffer, GtkTextTag * tag, GtkTextIter * startiter, GtkTextIter * enditer)
{
  // Only proceed if undo-able actions are to be recorded.
  if (record_undo_actions()) {
...
void USFMView::on_buffer_insert_child_anchor(GtkTextBuffer * textbuffer, GtkTextIter * pos_iter, GtkTextChildAnchor * childanchor, gpointer user_data)
{
  ((USFMView *) user_data)->buffer_insert_child_anchor(textbuffer, pos_iter, childanchor);
}

void USFMView::buffer_insert_child_anchor(GtkTextBuffer * textbuffer, GtkTextIter * pos_iter, GtkTextChildAnchor * childanchor)
{
  // Only proceed if undo-able actions are to be recorded.
  if (record_undo_actions()) {
    // Signal that the editor changed.
...
void USFMView::on_buffer_insert_pixbuf(GtkTextBuffer * textbuffer, GtkTextIter * pos_iter, GdkPixbuf * pixbuf, gpointer user_data)
{
  ((USFMView *) user_data)->buffer_insert_pixbuf(textbuffer, pos_iter, pixbuf);
}

void USFMView::buffer_insert_pixbuf(GtkTextBuffer * textbuffer, GtkTextIter * pos_iter, GdkPixbuf * pixbuf)
{
  // Signal that the editor changed.
  signal_editor_changed();
}

void USFMView::collect_text_child_anchors_being_deleted(GtkTextIter * startiter, GtkTextIter * enditer)
...
void USFMView::process_text_child_anchors_deleted()
...
void USFMView::text_append(GtkTextBuffer * textbuffer, const ustring & text, const ustring & paragraph_style, const ustring & character_style)
...
void USFMView::signal_if_styles_changed()
{
...
set < ustring > USFMView::get_styles_at_cursor()
...
set < ustring > USFMView::styles_at_iterator(GtkTextIter iter)
...
GtkWidget *USFMView::last_focused_textview()
// Returns the textview that was focused last.
{
  return last_focused_widget;
}

EditorTextViewType USFMView::last_focused_type()
...
unsigned int USFMView::last_focused_column()
...
void USFMView::apply_style(const ustring & marker)
/*
...
bool USFMView::on_apply_style_at_cursor(gpointer user_data)
{
  ((USFMView *) user_data)->apply_style_at_cursor_handler();
  return false;
}

void USFMView::apply_style_at_cursor_handler()
{
  apply_style(style_to_be_applied_at_cursor);
}

void USFMView::insert_note(const ustring & marker, const ustring & rawtext, GtkTextIter * iter, bool render)
/*
...
void USFMView::insert_table(const ustring & rawtext, GtkTextIter * iter)
/*
...
void USFMView::list_undo_buffer()
{
  /*
...
void USFMView::store_undo_action(const EditorUndo & editorundo)
/*
...
bool USFMView::record_undo_actions()
...
{
  ((USFMView *) user_data)->textbuffer_changed(textbuffer);
}

void USFMView::textbuffer_changed(GtkTextBuffer * textbuffer)
{
  spelling_trigger();
}

void USFMView::on_textbuffer_modified_changed(GtkTextBuffer * textbuffer, gpointer user_data)
{
}
...
void USFMView::test(ustring message)
{
}

void USFMView::highlight_searchwords()
...
bool USFMView::on_highlight_timeout(gpointer data)
{
  return ((USFMView *) data)->highlight_timeout();
}

bool USFMView::highlight_timeout()
{
...
void USFMView::highlight_thread_start(gpointer data)
{
  ((USFMView *) data)->highlight_thread_main();
}

void USFMView::highlight_thread_main()
{
...
void USFMView::signal_editor_changed()
{
...
void USFMView::check_move_textview_to_textview()
{
...
void USFMView::position_cursor_at_verse(const ustring & cursorposition, bool focus)
...
bool USFMView::on_restart_verse_tracker_timeout(gpointer data)
// Timeout callback.
{
  return ((USFMView *) data)->on_restart_verse_tracker();
}

bool USFMView::on_restart_verse_tracker()
...
// Timeout callback.
{
  return ((USFMView *) data)->verse_tracker_timeout();
}

bool USFMView::verse_tracker_timeout()
