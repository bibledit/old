...
PDFViewerDialog::PDFViewerDialog (int dummy)
{
  ...
  new InDialogHelp (pdfviewerdialog, &shortcuts, NULL);
  ...
  g_signal_connect ((gpointer) radiobutton_automatic, "toggled",
                    G_CALLBACK (on_radiobutton_toggled),
                    gpointer (this));
  g_signal_connect ((gpointer) radiobutton_manual, "toggled",
                    G_CALLBACK (on_radiobutton_toggled),
                    gpointer (this));
