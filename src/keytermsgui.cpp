...
KeytermsGUI::KeytermsGUI(GtkWidget * notebook_vbox,
    GtkWidget * textview_check_text_in)
  {
    // Save / initialize variables.
    textview_check_text = textview_check_text_in;
    previous_reference_id = 0;

    // Build gui.
    label23 = gtk_label_new_with_mnemonic("Ke_yterm");
    gtk_widget_show(label23);
    gtk_box_pack_start(GTK_BOX (notebook_vbox), label23, FALSE, FALSE, 0);
    gtk_misc_set_alignment(GTK_MISC (label23), 0, 0.5);

    entry_keyterm = gtk_entry_new();
    gtk_widget_show(entry_keyterm);
    gtk_box_pack_start(GTK_BOX (notebook_vbox), entry_keyterm, FALSE, FALSE, 0);
    ...
    gtk_box_pack_start(GTK_BOX (notebook_vbox), signal, FALSE, FALSE, 0);

    label24 = gtk_label_new_with_mnemonic("_Collection");
    gtk_widget_show(label24);
    gtk_box_pack_start(GTK_BOX (notebook_vbox), label24, FALSE, FALSE, 0);
    gtk_misc_set_alignment(GTK_MISC (label24), 0, 0.5);

    combobox_collection = gtk_combo_box_new_text();
    gtk_widget_show(combobox_collection);
    gtk_box_pack_start(GTK_BOX (notebook_vbox), combobox_collection, FALSE, TRUE, 0);

    label25 = gtk_label_new_with_mnemonic("_List");
    gtk_widget_show(label25);
    gtk_box_pack_start(GTK_BOX (notebook_vbox), label25, FALSE, FALSE, 0);
    gtk_misc_set_alignment(GTK_MISC (label25), 0, 0.5);

    scrolledwindow_keyterm = gtk_scrolled_window_new(NULL, NULL);
    gtk_widget_show(scrolledwindow_keyterm);
    gtk_box_pack_start(GTK_BOX (notebook_vbox), scrolledwindow_keyterm, TRUE, TRUE, 0);
    ...
    treecolumn_keywords = gtk_tree_view_column_new_with_attributes("",
        renderer_keywords, "text", 0, NULL);
    ...
    gtk_box_pack_start(GTK_BOX (notebook_vbox), scrolledwindow_comments, TRUE, TRUE, 0);
    ...
    gtk_box_pack_start(GTK_BOX (notebook_vbox), scrolledwindow_renderings, TRUE, TRUE, 0);
    ...
    column = gtk_tree_view_column_new_with_attributes("Case\nsensitive",
        renderer_renderings, "active", 1, NULL);
    gtk_tree_view_append_column(GTK_TREE_VIEW (treeview_renderings), column);
    ...
    column = gtk_tree_view_column_new_with_attributes("Rendering",
        renderer_renderings, "text", 2, "editable", 3, NULL);
    gtk_tree_view_append_column(GTK_TREE_VIEW (treeview_renderings), column);
...
void KeytermsGUI::focus_entry()
  {
    gtk_widget_grab_focus(entry_keyterm);
  }

void KeytermsGUI::copy_clipboard()
  {
    ...
    gtk_text_buffer_get_iter_at_mark(buffer, &enditer,
...
void KeytermsGUI::on_entry_keyterm_changed(GtkEditable *editable,
    gpointer user_data)
  {
    ((KeytermsGUI *) user_data)->on_entry_keyterm_change();
  }

void KeytermsGUI::on_entry_keyterm_activate(GtkEntry *entry, gpointer user_data)
  {
    ((KeytermsGUI *) user_data)->on_entry_keyterm_activated();
  }

void KeytermsGUI::on_combobox_keyterm_collection_changed(GtkComboBox *combobox,
    gpointer user_data)
  {
    ((KeytermsGUI *) user_data)->on_combobox_keyterm_collection();
  }

gboolean KeytermsGUI::on_treeview_keyterm_button_press_event(GtkWidget *widget,
    GdkEventButton *event, gpointer user_data)
  {
    ((KeytermsGUI *) user_data)->on_treeview_keyterm_button_press();
    return false;
  }

gboolean KeytermsGUI::on_treeview_keyterm_key_press_event(GtkWidget *widget,
    GdkEventKey *event, gpointer user_data)
  {
    ((KeytermsGUI *) user_data)->on_treeview_keyterm_key_press();
    return false;
  }

void KeytermsGUI::on_treeview_keyterm_row_activated(GtkTreeView *treeview,
    GtkTreePath *path, GtkTreeViewColumn *column, gpointer user_data)
  {
    ((KeytermsGUI *) user_data)->on_treeview_keyterm_activated();
  }

void KeytermsGUI::keyterm_whole_word_toggled(GtkCellRendererToggle *cell,
    gchar *path_str, gpointer data)
  {
    ((KeytermsGUI *) data)->on_rendering_toggle(cell, path_str, true);
  }

void KeytermsGUI::keyterm_case_sensitive_toggled(GtkCellRendererToggle *cell,
    gchar *path_str, gpointer data)
  {
    ((KeytermsGUI *) data)->on_rendering_toggle(cell, path_str, false);
  }

void KeytermsGUI::cell_edited(GtkCellRendererText *cell,
    const gchar *path_string, const gchar *new_text, gpointer data)
  {
    ((KeytermsGUI *) data)->on_cell_edited(cell, path_string, new_text);
  }

gboolean KeytermsGUI::on_textview_keyterm_text_button_press_event(
    GtkWidget *widget, GdkEventButton *event, gpointer user_data)
  {
    return ((KeytermsGUI *) user_data)->on_textview_keyterm_text_button_press(event);
  }

gboolean KeytermsGUI::on_textview_keyterm_text_button_release_event(
    GtkWidget *widget, GdkEventButton*event, gpointer user_data)
  {
    return ((KeytermsGUI *) user_data)->on_textview_keyterm_text_button_release(event);
  }

gboolean KeytermsGUI::on_textview_keyterm_text_key_press_event(
    GtkWidget *widget, GdkEventKey *event, gpointer user_data)
  {
    return ((KeytermsGUI *) user_data)->on_textview_keyterm_text_key_press(event);
  }

void KeytermsGUI::on_entry_keyterm_change()
  {
    ...
    for (unsigned int i1 = 0; i1 < terms1.size(); i1++)
      {
        ...
        gtk_tree_store_set(treestore_keywords, &iter1, 0, terms1[i1].c_str(),
            1, ids1[i1], -1);
        GtkTreePath * path1;
            ...
            if (parents2[i2] == ids1[i1])
              {
                ...
                gtk_tree_store_set(treestore_keywords, &iter2, 0,
                    terms2[i2].c_str(), 1, ids2[i2], -1);
                GtkTreePath * path2;
                ...
                for (unsigned int i3 = 0; i3 < parents3.size(); i3++)
                  {
                    if (parents3[i3] == ids2[i2])
                      {
                        GtkTreeIter iter3;
                        gtk_tree_store_append(treestore_keywords, &iter3,
                            &iter2);
                        gtk_tree_store_set(treestore_keywords, &iter3, 0,
                            terms3[i3].c_str(), 1, ids3[i3], -1);
                        GtkTreePath * path3;
                        ...
                        for (unsigned int i4 = 0; i4 < parents4.size(); i4++)
                          {
                            if (parents4[i4] == ids3[i3])
                              {
                                GtkTreeIter iter4;
                                gtk_tree_store_append(treestore_keywords,
                                    &iter4, &iter3);
                                gtk_tree_store_set(treestore_keywords, &iter4,
                                    0, terms4[i4].c_str(), 1, ids4[i4], -1);
                                GtkTreePath * path4;
...
void KeytermsGUI::on_entry_keyterm_activated()
  {
    gtk_widget_grab_focus(treeview_keyterm);
    show_information();
  }

void KeytermsGUI::on_combobox_keyterm_collection()
  {
    on_entry_keyterm_change();
  }

void KeytermsGUI::on_treeview_keyterm_button_press()
  {
    //  on_treeview_change ();
  }

void KeytermsGUI::on_treeview_keyterm_key_press()
  {
    //  on_treeview_change ();
  }

void KeytermsGUI::on_treeview_keyterm_activated()
  {
    show_information();
...
void KeytermsGUI::on_treeview_change()
  {
    g_timeout_add(1, GSourceFunc(treeview_changed_timeout), gpointer(this));
  }

bool KeytermsGUI::treeview_changed_timeout(gpointer data)
  {
    ((KeytermsGUI *) data)->show_information();
    return false;
  }

void KeytermsGUI::show_information()
// Show all data for the selected keyword. Most important data at the top.
  {
    ...
    if (references.size() == 0)
      string_append_line(information1,
          "This one has no references of its own. Select one of its descendants.");
...
void KeytermsGUI::load_renderings()
  {
    extern Settings * settings;
    myproject = settings->genconfig.project_get();
    ...
    keyterms_retrieve_renderings(myproject, keyterm, category, renderings,
    ...
    for (unsigned int i = 0; i < renderings.size(); i++)
      {
        ...
        gtk_tree_store_set(treestore_renderings, &iter, 0, wholeword, 1,
            casesensitive, 2, renderings[i].c_str(), 3, 1, -1);
      }
    gtk_tree_store_append(treestore_renderings, &iter, NULL);
    gtk_tree_store_set(treestore_renderings, &iter, 0, false, 1, true, 2,
        enter_new_rendering_here ().c_str(), 3, 1, -1);
  }

void KeytermsGUI::save_renderings()
  {
    vector <ustring> renderings;
    vector <bool> wholewords;
    vector <bool> casesensitives;
    ...
    keyterms_store_renderings(myproject, keyterm, category, renderings,
        wholewords, casesensitives);
    load_renderings();
    check_text();
  }

void KeytermsGUI::on_rendering_toggle(GtkCellRendererToggle *cell,
    gchar *path_str, bool first_toggle)
  {
...
void KeytermsGUI::on_cell_edited(GtkCellRendererText *cell,
...
void KeytermsGUI::add_to_renderings(const ustring& rendering, bool wholeword)
...
// casesensitive is set too.
  {
    ...
    gtk_tree_store_set(treestore_renderings, &iter, 0, wholeword, 1,
        casesensitive, 2, rendering.c_str(), 3, 1, -1);
    save_renderings();
  }

void KeytermsGUI::show_text()
        ...
        for (unsigned int i = 0; i < myreferences.size(); i++)
          {
            ...
            vector<int> chapters;
            vector<int> verses;
            mapping.original_to_me(myreferences[i].chapter,
                myreferences[i].verse, chapters, verses);
            for (unsigned int i2 = 0; i2 < chapters.size(); i2++)
              {
                Reference reference(myreferences[i].book, chapters[i2],
                    convert_to_string(verses[i2]));
    ...
    for (unsigned int i = 0; i < myreferences.size(); i++)
      {
        ...
        ustring reference =
            myreferences[i].human_readable(projectconfig->language_get());
        reference.append(" ");
        gtk_text_buffer_insert(buffer, &startiter, reference.c_str(), -1);

        // Insert the verse text, store the marks.
        ustring verse = project_retrieve_verse(
            settings->genconfig.project_get(), myreferences[i].book,
            myreferences[i].chapter, myreferences[i].verse);
        if (verse.empty())
          {
            verse.append("<empty>");
          }
        ...
        gtk_text_buffer_get_iter_at_offset(buffer, &startiter,
            start_reference_offset);
        gtk_text_buffer_get_end_iter(buffer, &enditer);
...
// text contains the renderings.
  {
    ...
    if (!approved_rendering_tag)
      {
        approved_rendering_tag = gtk_text_buffer_create_tag(buffer, NULL,
            "background", "khaki", NULL);
      }
    if (!disapproved_rendering_tag)
      {
        disapproved_rendering_tag = gtk_text_buffer_create_tag(buffer, NULL,
            "background", "red", NULL);
      }
    ...
    gtk_text_buffer_get_start_iter(buffer, &startiter);
    gtk_text_buffer_get_end_iter(buffer, &enditer);
    gtk_text_buffer_remove_tag(buffer, approved_rendering_tag, &startiter,
        &enditer);
    gtk_text_buffer_remove_tag(buffer, disapproved_rendering_tag, &startiter,
        &enditer);
    ...
    for (unsigned int i = 0; i < mytextstarts.size(); i++)
      {
        ...
        ustring text = gtk_text_buffer_get_text(buffer, &startiter, &enditer,
            false);
            ...
            while (position != string::npos)
              {
                ...
                if (myapproved)
                  {
                    approved = true;
                    gtk_text_buffer_apply_tag(buffer, approved_rendering_tag,
        ...
        if (!approved)
          {
            gtk_text_buffer_apply_tag(buffer, disapproved_rendering_tag,
                &startiter, &enditer);
          }
      }
  }

gboolean KeytermsGUI::on_textview_keyterm_text_button_press(
    ...
    if (event->type == GDK_2BUTTON_PRESS)
      {
        ...
        ustring word = gtk_text_buffer_get_text(buffer, &startiter, &enditer,
            false);
...
gboolean KeytermsGUI::on_textview_keyterm_text_button_release(
    GdkEventButton *event)
  {
...
gboolean KeytermsGUI::on_textview_keyterm_text_key_press(GdkEventKey *event)
  {
    check_move_new_reference();
    return false;
  }

void KeytermsGUI::check_move_new_reference()
  {
    // Get the textbuffer.
    GtkTextBuffer * buffer = gtk_text_view_get_buffer(GTK_TEXT_VIEW (textview_check_text));
...
unsigned int KeytermsGUI::selected_id()
  {
    // Selected id.
    unsigned int id = 0;
    // Get the model
...
ustring KeytermsGUI::all_categories()
  {
    return "All collections";
  }

ustring KeytermsGUI::enter_new_rendering_here()
  {
    return "<Enter new rendering here>";
  }

void KeytermsGUI::get_renderings(vector <ustring>& renderings,
    vector<bool>& wholewords, vector<bool>& casesensitives)
  {
    GtkTreeModel * model = (GtkTreeModel *) treestore_renderings;
    GtkTreeIter iter;
    gboolean valid;
    ...
    while (valid)
      {
        ...
        gchar *str_data;
        gtk_tree_model_get(model, &iter, 0, &wholeword, 1, &casesensitive, 2,
            &str_data, -1);
...
bool KeytermsGUI::focused()
  {
    bool focused = false;
    if (GTK_WIDGET_HAS_FOCUS (entry_keyterm))
      focused = true;
    if (GTK_WIDGET_HAS_FOCUS (combobox_collection))
      focused = true;
    if (GTK_WIDGET_HAS_FOCUS (treeview_keyterm))
      focused = true;
    if (GTK_WIDGET_HAS_FOCUS (textview_comments))
      focused = true;
    if (GTK_WIDGET_HAS_FOCUS (treeview_renderings))
      focused = true;
