...
// Screen Layout Windows.
  {
    ...
    g_signal_connect ((gpointer) menuwindow, "focus_in_event",
        G_CALLBACK (on_window_focus_in_event),
        gpointer (this));
    g_signal_connect ((gpointer) menuwindow, "delete_event",
    ...
    g_signal_connect ((gpointer) textwindow, "focus_in_event",
        G_CALLBACK (on_window_focus_in_event),
        gpointer (this));
    g_signal_connect ((gpointer) textwindow, "delete_event",
        G_CALLBACK (on_window_delete_event),
        gpointer (this));
    ...
    g_signal_connect ((gpointer) noteswindow, "focus_in_event",
        G_CALLBACK (on_window_focus_in_event),
        gpointer (this));
    g_signal_connect ((gpointer) noteswindow, "delete_event",
        G_CALLBACK (on_window_delete_event),
        gpointer (this));
    ...
    g_signal_connect ((gpointer) toolswindow, "focus_in_event",
        G_CALLBACK (on_window_focus_in_event),
        gpointer (this));
...
gboolean WindowLayout::on_window_focus_in_event(GtkWidget *widget,
