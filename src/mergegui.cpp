...
{
  if (GTK_WIDGET_HAS_FOCUS (combobox_master))
    return true;
  if (GTK_WIDGET_HAS_FOCUS (combobox_edited))
    return true;
  if (GTK_WIDGET_HAS_FOCUS (textview1))
    return true;
  if (GTK_WIDGET_HAS_FOCUS (button_previous))
    return true;
  if (GTK_WIDGET_HAS_FOCUS (button_merge))
    return true;
  if (GTK_WIDGET_HAS_FOCUS (button_next))
    return true;
  return false;
}
