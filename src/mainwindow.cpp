...
MainWindow::MainWindow(unsigned long xembed) :
  navigation(0), selected_reference(0, 0, ""), bibletime(true), httpd(0)
  {
    ...
    if (guifeatures.project_management())
      {
        ...
        image4995 = gtk_image_new_from_stock("gtk-properties",
            GTK_ICON_SIZE_MENU);
        ...
        export_usfm_files
            = gtk_image_menu_item_new_with_mnemonic("_Unified Standard Format Markers files");
        gtk_widget_show(export_usfm_files);
        gtk_container_add(GTK_CONTAINER (export_project_menu), export_usfm_files);

        image12814
            = gtk_image_new_from_stock("gtk-convert", GTK_ICON_SIZE_MENU);
        gtk_widget_show(image12814);
        gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM (export_usfm_files), image12814);

        export_zipped_unified_standard_format_markers1
            = gtk_image_menu_item_new_with_mnemonic("_Zipped Unified Standard Format Markers");
        ...
        to_bibleworks_version_database_compiler
            = gtk_image_menu_item_new_with_mnemonic("_BibleWorks Version Database Compiler");
        ...
        export_to_sword_module
            = gtk_image_menu_item_new_with_mnemonic("_SWORD module");
        ...
        export_opendocument
            = gtk_image_menu_item_new_with_mnemonic("_OpenDocument");
    ...
    project_backup_incremental
        = gtk_image_menu_item_new_with_mnemonic("_Incremental");
    ...
    project_backup_flexible
        = gtk_image_menu_item_new_with_mnemonic("_Flexible");
    ...
    if (guifeatures.project_management())
      {
        ...
        image19115 = gtk_image_new_from_stock("gtk-zoom-fit",
            GTK_ICON_SIZE_MENU);
    ...
    if (guifeatures.references_management())
      {
        ...
        references_save_as = gtk_image_menu_item_new_from_stock("gtk-save-as",
            accel_group);
    ...
    if (guifeatures.references_management())
      {
        ...
        close_references
            = gtk_image_menu_item_new_with_mnemonic("D_ismiss all");
        ...
        reference_hide
            = gtk_image_menu_item_new_with_mnemonic("_Hide from now on");
    ...
    if (guifeatures.styles())
      {
        ...
        image10735 = gtk_image_new_from_stock("gtk-print-preview",
            GTK_ICON_SIZE_MENU);
    ...
    if (guifeatures.styles())
      {
        ...
        stylesheets_expand_all
            = gtk_image_menu_item_new_with_mnemonic("_Expand all");
    ...
    if (guifeatures.styles())
      {
        ...
        stylesheets_collapse_all
            = gtk_image_menu_item_new_with_mnemonic("_Collapse all");
    ...
    if (guifeatures.styles_management())
      {
        ...
        stylesheet_edit_mode
            = gtk_check_menu_item_new_with_mnemonic("Edit _mode");
    ...
    if (guifeatures.styles_management())
      {
        ...
        style_properties = gtk_image_menu_item_new_from_stock("gtk-properties",
            accel_group);
    ...
    if (guifeatures.styles_management())
      {
        ...
        style_delete = gtk_image_menu_item_new_from_stock("gtk-delete",
            accel_group);
    ...
    if (guifeatures.styles_management())
      {
        ...
        image10740 = gtk_image_new_from_stock("gtk-print-preview",
            GTK_ICON_SIZE_MENU);
    ...
    if (guifeatures.project_notes_management())
      {
        ...
        image936 = gtk_image_new_from_stock("gtk-dialog-info",
            GTK_ICON_SIZE_MENU);
    ...
    copy_without_formatting
        = gtk_image_menu_item_new_with_mnemonic("Copy _without formatting");
    gtk_widget_show(copy_without_formatting);
    gtk_container_add(GTK_CONTAINER (menuitem_edit_menu), copy_without_formatting);
    gtk_widget_add_accelerator(copy_without_formatting, "activate",
        accel_group, 
    ...
    gtk_widget_add_accelerator(undo1, "activate", accel_group, GDK_Z,
    ...
    if (guifeatures.replace())
      {
        ...
        find_and_replace1 = gtk_image_menu_item_new_from_stock(
            "gtk-find-and-replace", accel_group);
    ...
    find_in_notes1
        = gtk_image_menu_item_new_with_mnemonic("Find in Project _notes");
    ...
    get_references_from_note
        = gtk_image_menu_item_new_with_mnemonic("_Get references from project note");
    ...
    image20234
        = gtk_image_new_from_stock("gtk-select-font", GTK_ICON_SIZE_MENU);
    ...
    image11944 = gtk_image_new_from_stock("gtk-justify-fill",
        GTK_ICON_SIZE_MENU);
    ...
    parallel_passages1
        = gtk_check_menu_item_new_with_mnemonic("_Parallel passages");
    ...
    view_screen_layout
        = gtk_check_menu_item_new_with_mnemonic("_Screen layout");
    ...
    if (guifeatures.project_notes())
      {
        ...
        standard_text_1
            = gtk_image_menu_item_new_with_mnemonic("Standard text _1");
        ...
        standard_text_2
            = gtk_image_menu_item_new_with_mnemonic("Standard text _2");
        ...
        standard_text_3
            = gtk_image_menu_item_new_with_mnemonic("Standard text _3");
        ...
        standard_text_4
            = gtk_image_menu_item_new_with_mnemonic("Standard text _4");
        ...
        current_reference1
            = gtk_image_menu_item_new_with_mnemonic("_Current reference");
    ...
    insert_special_character
        = gtk_image_menu_item_new_with_mnemonic("_Special character");
    ...
    previous_chapter1
        = gtk_image_menu_item_new_with_mnemonic("Previous chapter");
    ...
    next_reference_in_history1
        = gtk_image_menu_item_new_with_mnemonic("Next reference in history");
    gtk_widget_show(next_reference_in_history1);
    gtk_container_add(GTK_CONTAINER (menuitem_goto_menu), next_reference_in_history1);
    gtk_widget_add_accelerator(next_reference_in_history1, "activate",
        accel_group, 
    ...
    previous_reference_in_history1
        = gtk_image_menu_item_new_with_mnemonic("Previous reference in history");
    ...
    gtk_widget_add_accelerator(previous_reference_in_history1, "activate",
        accel_group, 
    ...
    if (guifeatures.references_and_find())
      {
        ...
        next_reference1
            = gtk_image_menu_item_new_with_mnemonic("Next reference in Reference Area");
        ...
        previous_reference1
            = gtk_image_menu_item_new_with_mnemonic("Previous reference in Reference Area");
        gtk_widget_show(previous_reference1);
        gtk_container_add(GTK_CONTAINER (menuitem_goto_menu), previous_reference1);
        gtk_widget_add_accelerator(previous_reference1, "activate",
            accel_group, GDK_F6, GDK_SHIFT_MASK, GTK_ACCEL_VISIBLE);
    ...
    goto_previous_project
        = gtk_image_menu_item_new_with_mnemonic("Previous project");
    ...
    gtk_widget_add_accelerator(reference1, "activate", accel_group, GDK_g,
        GDK_CONTROL_MASK, GTK_ACCEL_VISIBLE);
    ...
    goto_bible_notes_area1
        = gtk_image_menu_item_new_with_mnemonic("Bible notes area");
    ...
    if (guifeatures.styles())
      {
        ...
        image11111 = gtk_image_new_from_stock("gtk-print-preview",
            GTK_ICON_SIZE_MENU);
    ...
    if (guifeatures.project_notes())
      {
        ...
        notes_area1
            = gtk_image_menu_item_new_with_mnemonic("Project notes area");
        ...
        image4723 = gtk_image_new_from_stock("gtk-dialog-info",
            GTK_ICON_SIZE_MENU);
    ...
    synchronize_other_programs2
        = gtk_image_menu_item_new_with_mnemonic("_Synchronize other programs");
    ...
    if (guifeatures.checks())
      {
        ...
        chapters_and_verses1
            = gtk_image_menu_item_new_with_mnemonic("_Chapters and verses");
        ...
        image6239 = gtk_image_new_from_stock("gtk-dialog-info",
            GTK_ICON_SIZE_MENU);
        ...
        check_markers_spacing
            = gtk_image_menu_item_new_with_mnemonic("_Spacing");
        gtk_widget_show(check_markers_spacing);
        gtk_container_add(GTK_CONTAINER (markers1_menu), check_markers_spacing);

        image17930 = gtk_image_new_from_stock("gtk-media-pause",
            GTK_ICON_SIZE_MENU);
        ...
        image6868 = gtk_image_new_from_stock("gtk-dialog-info",
            GTK_ICON_SIZE_MENU);
        gtk_widget_show(image6868);
        gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM (count_characters), image6868);

        unwanted_patterns
            = gtk_image_menu_item_new_with_mnemonic("_Unwanted patterns");
        ...
        check_capitalization
            = gtk_image_menu_item_new_with_mnemonic("_Capitalization");
        ...
        check_matching_pairs
            = gtk_image_menu_item_new_with_mnemonic("_Matching pairs");
        ...
        image21826 = gtk_image_new_from_stock("gtk-zoom-fit",
            GTK_ICON_SIZE_MENU);
        ...
        check_references_validate
            = gtk_image_menu_item_new_with_mnemonic("_Validate");
        gtk_widget_show(check_references_validate);
        gtk_container_add(GTK_CONTAINER (check_references_menu), check_references_validate);

        image21828 = gtk_image_new_from_stock("gtk-spell-check",
            GTK_ICON_SIZE_MENU);
        ...
        image24103 = gtk_image_new_from_stock("gtk-justify-fill",
            GTK_ICON_SIZE_MENU);
        ...
        check_nt_quotations_from_the_ot
            = gtk_image_menu_item_new_with_mnemonic("_NT quotations from the OT");
        ...
        synoptic_parallel_passages_from_the_nt
            = gtk_image_menu_item_new_with_mnemonic("_Synoptic parallels from the NT");
        ...
        parallels_from_the_ot
            = gtk_image_menu_item_new_with_mnemonic("_Parallels from the OT");
    ...
    if (guifeatures.tools())
      {
        ...
        line_cutter_for_hebrew_text1
            = gtk_image_menu_item_new_with_mnemonic("_Line cutter for Hebrew text");
        ...
        notes_transfer
            = gtk_image_menu_item_new_with_mnemonic("_Transfer text to project notes");
        ...
        tool_origin_references_in_bible_notes
            = gtk_image_menu_item_new_with_mnemonic("_Bible notes mass update");
        ...
        image16248 = gtk_image_new_from_stock("gtk-find-and-replace",
            GTK_ICON_SIZE_MENU);
        ...
        tool_project_notes_mass_update1
            = gtk_image_menu_item_new_with_mnemonic("_Project notes mass update");
    ...
    if (guifeatures.preferences())
      {
        ...
        reference_exchange1
            = gtk_image_menu_item_new_with_mnemonic("_Reference exchange");
        ...
        ignored_references1
            = gtk_image_menu_item_new_with_mnemonic("_Ignored references");
        ...
        preferences_windows_outpost
            = gtk_image_menu_item_new_with_mnemonic("_Windows Outpost");
        ...
        preferences_tidy_text
            = gtk_image_menu_item_new_with_mnemonic("_Tidy text");
        ...
        preferences_remote_git_repository
            = gtk_image_menu_item_new_with_mnemonic("_Git repository");
        ...
        image18977
            = gtk_image_new_from_stock("gtk-connect", GTK_ICON_SIZE_MENU);
    ...
    if (guifeatures.preferences())
      {
        ...
        image23181 = gtk_image_new_from_stock("gtk-find-and-replace",
            GTK_ICON_SIZE_MENU);
        ...
        image27031 = gtk_image_new_from_stock("gtk-fullscreen",
            GTK_ICON_SIZE_MENU);
    ...
    navigation.build(toolbar1, next_reference_in_history1,
        previous_reference_in_history1);
    ...
    image29114
        = gtk_image_new_from_stock("gtk-underline", GTK_ICON_SIZE_BUTTON);
    ...
    image29123 = gtk_image_new_from_stock("gtk-strikethrough",
    ...
    image29124 = gtk_image_new_from_stock("gtk-justify-left",
        GTK_ICON_SIZE_BUTTON);
    ...
    image29125 = gtk_image_new_from_stock("gtk-justify-center",
        GTK_ICON_SIZE_BUTTON);
    ...
    image29126 = gtk_image_new_from_stock("gtk-justify-right",
        GTK_ICON_SIZE_BUTTON);
    ...
    if (settings->genconfig.tools_area_left_get())
      {
        screen_layout_tools_area_set(false, vbox_left, vbox_right, vpaned1,
            notebook_tools);
      }
    ...
    treecolumn_references = gtk_tree_view_column_new_with_attributes("",
        renderer, "text", 0, NULL);
    gtk_tree_view_append_column(GTK_TREE_VIEW (treeview_references), treecolumn_references);
    // Add comments column
    GtkTreeViewColumn * treecolumn2;
    treecolumn2 = gtk_tree_view_column_new_with_attributes("Comment", renderer,
        "text", 1, NULL);
    ...
    g_timeout_add(100, GSourceFunc(mainwindow_on_external_programs_timeout),
        gpointer(this));
    ...
    References references(liststore_references, treeview_references,
        treecolumn_references);
    references.load();
...
void MainWindow::on_properties1_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::deleteproject()
  {
    ...
    for (unsigned int i = 0; i < all_projects.size(); i++)
      {
        ...
        if (all_projects[i] == settings->genconfig.project_get())
          include = false;
        ProjectConfiguration * projectconfig =
            settings->projectconfig(all_projects[i]);
    ...
    if (dialog.run() == GTK_RESPONSE_OK)
      {
        int result;
        result = gtkw_dialog_question(mainwindow,
            "Are you sure you want to delete project " + dialog.focus + "?");
        if (result == GTK_RESPONSE_YES)
          {
            result = gtkw_dialog_question(mainwindow,
                "Are you really sure to delete project " + dialog.focus
                    + ", something worth perhaps years of work?");
          }
        if (result == GTK_RESPONSE_YES)
          {
...
void MainWindow::on_system_log1_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_help_context_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_help_main_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_find_and_replace1_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
    ...
    vector <Reference> results;
      {
        ...
        if (replacedialog.run() == GTK_RESPONSE_OK)
          {
            results.assign(replacedialog.results.begin(),
                replacedialog.results.end());
            References references(liststore_references, treeview_references,
                treecolumn_references);
...
void MainWindow::on_findspecial1_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::menu_findspecial()
  {
    ...
    search_string(liststore_references, treeview_references,
        treecolumn_references, &bibletime);
  }
...
gboolean MainWindow::on_mainwindow_focus_in_event(GtkWidget *widget,
...
// Sets the labels of the underlying menu items right.
  {
    ...
    if (gtk_notebook_get_current_page(GTK_NOTEBOOK (notebook1)) == 1)
      {
        ...
        notes_get_references_from_editor(note_editor->textbuffer_references,
            references, messages);
    ...
    if (editor)
      {
        label
            = "_Add "
                + editor->current_reference.human_readable(projectconfig->language_get())
                + " to project note";
      }
    else
      {
    ...
    gtk_widget_set_sensitive(insert_special_character, (editor
        && editor->has_focus()));
  }

void MainWindow::on_menuitem_view_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_notes_preferences_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_copy_project_to_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
    ...
    if (dialog.run() == GTK_RESPONSE_OK)
      {
        ...
        if ((project_exists(dialog.entered_value)) || (dialog.entered_value
            == "data"))
          {
        ...
        else
          {
            ...
            project_copy(settings->genconfig.project_get(),
...
void MainWindow::on_compare_with1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_printingprefs_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_screen_layout_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_prefs_books_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_preferences_tidy_text_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_navigation_new_reference_clicked(GtkButton *button,
    gpointer user_data)
  {
...
void MainWindow::on_navigation_new_reference()
  {
    ...
    go_to_new_reference();
    if (outline)
      outline->goto_reference(settings->genconfig.project_get(),
...
void MainWindow::on_previous_verse_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_next_chapter_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_previous_chapter_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_next_book_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_previous_book_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_reference_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::goto_reference_interactive()
  {
    Editor * editor = editorsgui->focused_editor();
    GotoReferenceDialog dialog(editor->current_reference.book,
        editor->current_reference.chapter, editor->current_reference.verse);
    if (dialog.run() == GTK_RESPONSE_OK)
      {
...
// This starts the procedure to carries out a requested change of reference.
  {
    ...
    Reference goto_reference(navigation.reference.book,
        navigation.reference.chapter,
        number_in_string(navigation.reference.verse));
 ...
 */
  {
    ...
    if (editor)
      {
        Reference reference(navigation.reference.book,
            navigation.reference.chapter, editor->current_verse_number);
...
void MainWindow::on_synchronize_other_programs2_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_text_area1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_goto_bible_notes_area1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_tools_area1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_tools_area_activate()
  {
    ...
    ToolsAreaPageNumberType page =
        (ToolsAreaPageNumberType) gtk_notebook_get_current_page(GTK_NOTEBOOK (notebook_tools));
...
void MainWindow::on_notes_area1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_goto_next_project_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
    ((MainWindow *) user_data)->editorsgui->next_previous_project(true);
  }

void MainWindow::on_goto_previous_project_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_cut()
  {
    ...
    if (GTK_WIDGET_HAS_FOCUS (textview_note_references))
      gtk_text_buffer_cut_clipboard(note_editor->textbuffer_references,
          clipboard, true);
  }
...
void MainWindow::on_copy()
  {
    ...
    if (GTK_WIDGET_HAS_FOCUS (textview_note_references))
      gtk_text_buffer_copy_clipboard(note_editor->textbuffer_references,
          clipboard);
    if (keytermsgui)
      {
...
void MainWindow::on_copy_without_formatting_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
    ...
    if (editorsgui->has_focus())
      {
        ...
        if (editor)
          {
            gtk_text_buffer_copy_clipboard(editor->last_focused_textbuffer(),
                clipboard);
          }
      }
  }
...
void MainWindow::on_paste()
  {
    ...
    if (GTK_WIDGET_HAS_FOCUS (textview_note_references))
      gtk_text_buffer_paste_clipboard(note_editor->textbuffer_references,
          clipboard, NULL, true);
  }
...
void MainWindow::on_notebook_tools_switch_page(GtkNotebook *notebook,
...
void MainWindow::on_file_references_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
gboolean MainWindow::on_treeview_references_key_press_event(GtkWidget * widget,
...
gboolean MainWindow::on_treeview_references_button_press_event(
    GtkWidget * widget, GdkEventButton * event, gpointer user_data)
  {
    ...
    if (event->button == 3 && event->type == GDK_BUTTON_PRESS)
      {
        ((MainWindow *) user_data)->show_references_popup_menu(widget,
            event);
        return true;
      }
    return false;
...
void MainWindow::mainwindow_selection_foreach_function(GtkTreeModel * model,
...
void MainWindow::on_open_references1_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_open_references()
  {
    ...
    extern Settings * settings;
    // Ask for a file.
    ustring filename = gtkw_file_chooser_open(mainwindow, "Open File",
        settings->genconfig.references_file_get());
    if (filename.empty())
      return;
    ...
    vector <ustring> import_references_searchwords =
        settings->session.import_references_searchwords;
    ...
    Entry3Dialog dialog2("Search for", true,
        "Optionally enter _1st searchword", searchword1,
        "Optionally enter _2nd searchword", searchword2,
        "Optioanlly enter _3rd searchword", searchword3);
            ...
            for (unsigned int i = 0; i < import_references_searchwords.size(); i++)
              {
                SessionHighlights sessionhighlights(
                    import_references_searchwords[i], false, false, false,
                    false, atRaw, false, false, false, false, false, false,
                    false, false);
...
void MainWindow::on_references_save_as_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_close_references_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_delete_references_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
    ((MainWindow *) user_data)->on_delete_references();
  }
...
void MainWindow::on_delete_references()
  {
    ...
    gtk_tree_selection_selected_foreach(selection,
        MainWindow::on_references_collect_iters, gpointer(&iters));
...
void MainWindow::on_references_collect_iters(GtkTreeModel * model,
    GtkTreePath * path, GtkTreeIter * iter, gpointer data)
  {
    ((vector < GtkTreeIter> *)data)->push_back(*iter);
  }

void MainWindow::on_next_reference1_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_previous_reference1_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_ignored_references1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
gboolean MainWindow::on_treeview_references_popup_menu(GtkWidget *widget,
    gpointer user_data)
  {
...
void MainWindow::on_reference_hide_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
    ...
    for (unsigned int i = 0; i < iters.size(); i++)
      {
        ...
        gchar *verse;
        gchar *comment;
        gtk_tree_model_get(model, &iters[i], 1, &comment, 2, &book, 3,
            &chapter, 4, &verse, -1);
...
void MainWindow::show_references_popup_menu(GtkWidget *my_widget,
...
gboolean MainWindow::on_treeview_references_move_cursor(GtkTreeView *treeview,
    GtkMovementStep step, gint count, gpointer user_data)
  {
    return false;
  }

void MainWindow::on_treeview_references_cursor_changed(GtkTreeView *treeview,
    gpointer user_data)
  {
    ...
    for (unsigned int i = 0; i < iters.size(); i++)
      {
        gint book, chapter;
        gchar *verse;
        gtk_tree_model_get(model, &iters[i], 2, &book, 3, &chapter, 4, &verse,
            -1);
        // Get and display the verse.
        ustring text = project_retrieve_verse(
            settings->genconfig.project_get(), book, chapter, verse);
        ...
        if (editor)
          {
            if (settings->genconfig.reference_exchange_send_to_bibletime_get())
              {
                ustring bibledit_bt_new_reference =
                    convert_to_string(editor->current_reference.book)
                        + convert_to_string(editor->current_reference.chapter)
                        + editor->current_reference.verse;
...
void MainWindow::on_reference_exchange1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_send_word_to_toolbox_signalled(GtkButton *button,
    gpointer user_data)
  {
...
void MainWindow::on_preferences_windows_outpost_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
    ...
    // they are set only when there was a change that makes it needed.
      {
        ...
        if (undo_redo_state != editor_undo_redo_accelerator_state)
          {
            gtk_widget_remove_accelerator(undo1, accel_group, GDK_Z,
                GDK_CONTROL_MASK);
            gtk_widget_add_accelerator(undo1, "activate", accel_group, GDK_Z,
                GDK_CONTROL_MASK, GTK_ACCEL_VISIBLE);
            gtk_widget_remove_accelerator(redo1, accel_group, GDK_Z,
...
gboolean MainWindow::on_mainwindow_window_state_event(GtkWidget *widget,
    GdkEvent *event, gpointer user_data)
  {
...
void MainWindow::on_mainwindow_window_state(GdkEvent *event)
  {
    ...
    if (settings->session.window_initialized)
      {
        bool maximized = ((GdkEventWindowState *)event)->new_window_state
...
void MainWindow::on_window_size_allocated(GtkWidget *widget,
    GtkAllocation *allocation, gpointer user_data)
  {
    ((MainWindow *) user_data)->window_size_allocated(widget, allocation);
  }

void MainWindow::window_size_allocated(GtkWidget *widget,
...
void MainWindow::on_delete_note_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
    gtkw_dialog_info(((MainWindow *) user_data)->mainwindow,
        "A note can be deleted by clicking on the [delete] link in the notes view");
  }
...
void MainWindow::notes_redisplay()
  {
    ...
    notes_redisplay_source_id
        = g_timeout_add_full(G_PRIORITY_DEFAULT, 500, GSourceFunc (on_notes_redisplay_timeout), gpointer(this), NULL);
  }
...
void MainWindow::notes_redisplay_timeout()
  {
    ...
    ustring reference = books_id_to_english(editor->current_reference.book)
        + " " + convert_to_string(editor->current_reference.chapter) + ":"
        + editor->current_reference.verse;
...
void MainWindow::on_find_in_notes1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_import_notes_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_export_notes_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
    ...
    if (result == GTK_RESPONSE_OK)
      {
        ...
        export_translation_notes(filename, format, ids_to_display,
            save_all_notes, mainwindow);
      }
  }
 ...
 */
  {
    ...
    note_editor->textbuffer_references
        = gtk_text_view_get_buffer(GTK_TEXT_VIEW (textview_note_references));
    ...
    int tools_page_displayed_previously =
        gtk_notebook_get_current_page(GTK_NOTEBOOK (notebook_tools));
    ...
    combobox_set_strings(combobox_note_edit_font_size,
        note_editor_font_size_names_list());
    combobox_set_string(combobox_note_edit_font_size,
        note_editor_font_size_enum_to_name(GTK_HTML_FONT_STYLE_DEFAULT));
    combobox_set_strings(combobox_note_edit_paragraph_style,
        note_editor_paragraph_style_names_list());
    combobox_set_string(
        combobox_note_edit_paragraph_style,
        note_editor_paragraph_style_enum_to_name(GTK_HTML_PARAGRAPH_STYLE_NORMAL));
    ...
    note_editor->previous_category
        = combobox_get_active_string(combobox_note_category);
    note_editor->previous_project
        = combobox_get_active_string(combobox_note_project);
...
void MainWindow::on_standard_text_1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
    ((MainWindow *) user_data)->on_insert_standard_text(menuitem);
  }

void MainWindow::on_standard_text_2_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
    ((MainWindow *) user_data)->on_insert_standard_text(menuitem);
  }

void MainWindow::on_standard_text_3_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
    ((MainWindow *) user_data)->on_insert_standard_text(menuitem);
  }

void MainWindow::on_standard_text_4_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
    ((MainWindow *) user_data)->on_insert_standard_text(menuitem);
  }

void MainWindow::on_current_reference1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
    ((MainWindow *) user_data)->on_insert_standard_text(menuitem);
  }
...
void MainWindow::on_insert_standard_text(GtkMenuItem *menuitem)
  {
    ...
    if (menuitem == GTK_MENU_ITEM (standard_text_1))
    ...
    else if (menuitem == GTK_MENU_ITEM (current_reference1))
      {
        Editor * editor = editorsgui->focused_editor();
        if (editor)
          standardtext = books_id_to_english(editor->current_reference.book)
              + " " + convert_to_string(editor->current_reference.chapter)
              + ":" + editor->current_reference.verse;
        addspace = false;
    ...
    if (!gtkhtml)
      {
        ...
        if (gtk_text_buffer_get_selection_bounds(
            gtk_text_view_get_buffer(GTK_TEXT_VIEW (textview)), &iter1, &iter2))
          {
...
void MainWindow::on_get_references_from_note_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_get_references_from_note()
  {
    ...
    settings->session.highlights.clear();
    // Set references.
    References references2(liststore_references, treeview_references,
        treecolumn_references);
...
gboolean MainWindow::note_save_receiver(const HTMLEngine * engine,
...
gboolean MainWindow::on_notes_html_link_clicked(GtkHTML *html,
...
void MainWindow::on_combobox_note_edit_font_size_changed(GtkComboBox *combobox,
    gpointer user_data)
  {
...
void MainWindow::combobox_note_edit_font_size_changed()
  {
    GtkHTMLFontStyle
        style =
            note_editor_font_size_name_to_enum(combobox_get_active_string(combobox_note_edit_font_size));
...
void MainWindow::on_note_editor_insertion_font_style_changed(GtkHTML * html,
...
void MainWindow::note_editor_insertion_font_style_changed(GtkHTMLFontStyle style)
  {
    combobox_set_string(combobox_note_edit_font_size,
        note_editor_font_size_enum_to_name(GtkHTMLFontStyle(style
...
void MainWindow::on_combobox_note_edit_paragraph_style_changed(
...
void MainWindow::combobox_note_edit_paragraph_style_changed()
  {
    GtkHTMLParagraphStyle
        style =
            note_editor_paragraph_style_name_to_enum(combobox_get_active_string(combobox_note_edit_paragraph_style));
    gtk_html_set_paragraph_style(GTK_HTML (htmlview_note_editor), style);
  }

void MainWindow::on_note_editor_current_paragraph_style_changed(GtkHTML * html,
    GtkHTMLParagraphStyle style, gpointer user_data)
  {
    ((MainWindow *) user_data)->note_editor_current_paragraph_style_changed(style);
  }

void MainWindow::note_editor_current_paragraph_style_changed(
    GtkHTMLParagraphStyle style)
  {
    combobox_set_string(combobox_note_edit_paragraph_style,
        note_editor_paragraph_style_enum_to_name(style));
  }

void MainWindow::on_togglebutton_note_edit_bold_toggled(
...
void MainWindow::on_togglebutton_note_edit_italics_toggled(
    GtkToggleButton *togglebutton, gpointer user_data)
  {
...
void MainWindow::on_togglebutton_note_edit_underline_toggled(
    GtkToggleButton *togglebutton, gpointer user_data)
  {
...
void MainWindow::on_togglebutton_note_edit_strike_through_toggled(
    GtkToggleButton *togglebutton, gpointer user_data)
  {
...
void MainWindow::on_togglebutton_note_edit_left_justify_toggled(
    GtkToggleButton *togglebutton, gpointer user_data)
  {
...
void MainWindow::on_togglebutton_note_edit_center_justify_toggled(
    GtkToggleButton *togglebutton, gpointer user_data)
  {
...
void MainWindow::on_togglebutton_note_edit_right_justify_toggled(
    GtkToggleButton *togglebutton, gpointer user_data)
  {
...
void MainWindow::on_current_paragraph_alignment_changed(GtkHTML *html,
...
void MainWindow::current_paragraph_alignment_changed(
...
void MainWindow::on_button_note_edit_decrease_indent_clicked(GtkButton *button,
    gpointer user_data)
  {
...
void MainWindow::on_button_note_edit_increase_indent_clicked(GtkButton *button,
    gpointer user_data)
  {
...
void MainWindow::on_current_paragraph_indentation_changed(GtkHTML *html,
...
void MainWindow::on_colorbutton_note_edit_color_set(
    GtkColorButton *colorbutton, gpointer user_data)
  {
...
void MainWindow::on_insertion_color_changed(GtkHTML *html, GdkColor *color,
    gpointer user_data)
  {
...
void MainWindow::on_export_usfm_files_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
    ((MainWindow *) user_data)->on_export_usfm_files(false);
  }

void MainWindow::on_export_zipped_unified_standard_format_markers1_activate(
...
void MainWindow::on_to_bibleworks_version_compiler_activate(
    GtkMenuItem *menuitem, gpointer user_data)
  {
...
void MainWindow::on_export_to_sword_module_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_export_opendocument_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_validate_usfms1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_menu_check_markers_validate()
  {
    editorsgui->save();
    scripture_checks_validate_usfms(liststore_references, treeview_references,
        treecolumn_references, NULL);
  }

void MainWindow::on_count_usfms1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_compare_usfm1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_menu_check_markers_compare()
  {
    editorsgui->save();
    scripture_checks_compare_usfms(liststore_references, treeview_references,
        treecolumn_references, NULL);
  }

void MainWindow::on_chapters_and_verses1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_menu_check_chapters_and_verses()
  {
    editorsgui->save();
    scripture_checks_chapters_verses(liststore_references, treeview_references,
        treecolumn_references, NULL);
  }

void MainWindow::on_count_characters_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_unwanted_patterns_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_unwanted_patterns()
  {
    editorsgui->save();
    scripture_checks_unwanted_patterns(liststore_references,
        treeview_references, treecolumn_references, NULL);
  }

void MainWindow::on_check_capitalization_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_check_capitalization()
  {
    editorsgui->save();
    scripture_checks_capitalization(liststore_references, treeview_references,
        treecolumn_references, NULL);
  }

void MainWindow::on_check_repetition_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_check_repetition()
  {
    editorsgui->save();
    scripture_checks_repetition(liststore_references, treeview_references,
        treecolumn_references, NULL);
  }

void MainWindow::on_check_matching_pairs_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_check_matching_pairs()
  {
    editorsgui->save();
    scripture_checks_matching_pairs(liststore_references, treeview_references,
        treecolumn_references, NULL);
  }

void MainWindow::on_unwanted_words_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_unwanted_words()
  {
    editorsgui->save();
    scripture_checks_unwanted_words(liststore_references, treeview_references,
        treecolumn_references, NULL);
  }

void MainWindow::on_word_count_inventory_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
    ...
    if (!httpd.search_whole_word.empty())
      {
        ...
        settings->session.highlights.clear();
        SessionHighlights sessionhighlights(settings->session.searchword,
            settings->session.search_case_sensitive,
            settings->session.search_globbing,
            settings->session.search_start_word_match,
            settings->session.search_end_word_match, atRaw, false, false,
...
void MainWindow::on_my_checks()
  {
    editorsgui->save();
    MyChecksDialog dialog(liststore_references, treeview_references,
        treecolumn_references);
    dialog.run();
  }
...
void MainWindow::on_check_markers_spacing_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_check_markers_spacing()
  {
    editorsgui->save();
    scripture_checks_usfm_spacing(liststore_references, treeview_references,
        treecolumn_references, NULL);
  }

void MainWindow::on_check_references_inventory_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_check_references_validate_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_check_references_validate()
  {
    editorsgui->save();
    scripture_checks_validate_references(liststore_references,
        treeview_references, treecolumn_references, NULL);
  }

void MainWindow::on_check_nt_quotations_from_the_ot_activate(
    GtkMenuItem *menuitem, gpointer user_data)
  {
...
void MainWindow::on_synoptic_parallel_passages_from_the_nt_activate(
    GtkMenuItem *menuitem, gpointer user_data)
  {
...
void MainWindow::on_parallels_from_the_ot_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_check_sentence_structure_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_check_sentence_structure()
  {
    editorsgui->save();
    scripture_checks_sentence_structure(liststore_references,
        treeview_references, treecolumn_references, NULL);
  }
...
void MainWindow::on_goto_styles_area_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_file_styles_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_style_button_open_clicked(GtkButton *button,
    gpointer user_data)
...
void MainWindow::on_style_button_apply_clicked(GtkButton *button,
    gpointer user_data)
  {
    ...
    if (style.type == stChapterNumber)
      {
        ...
        if (gtkw_dialog_question(mainwindow,
            "Would you like to insert a new chapter?", GTK_RESPONSE_YES)
            == GTK_RESPONSE_YES)
          {
                ...
                if (style.type == stCrossreference)
                  {
                    ...
                    if (dialog.run() == GTK_RESPONSE_OK)
                      {
                        editor->insert_note(style.marker, dialog.rawtext, NULL,
                            true);
                      }
                    else
                      {
...
void MainWindow::on_edit_bible_note_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_line_cutter_for_hebrew_text1_activate(
    GtkMenuItem *menuitem, gpointer user_data)
  {
...
void MainWindow::on_notes_transfer_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_tool_origin_references_in_bible_notes_activate(
    GtkMenuItem *menuitem, gpointer user_data)
  {
...
void MainWindow::on_tool_project_notes_mass_update1_activate(
    GtkMenuItem *menuitem, gpointer user_data)
  {
...
void MainWindow::on_tool_generate_word_lists_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_tool_transfer_project_notes_to_text_activate(
    GtkMenuItem *menuitem, gpointer user_data)
  {
...
void MainWindow::on_preferences_features_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_preferences_password_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_preferences_text_replacement_activate(
    GtkMenuItem *menuitem, gpointer user_data)
  {
...
void MainWindow::on_parallel_passages1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_pdf_viewer1_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_view_usfm_code_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_view_usfm_code()
  {
    ...
    if (!editor)
      return;
    editorsgui->save();
    ustring filename = project_data_filename_chapter(editor->project,
        editor->book, editor->chapter, false);
...
void MainWindow::on_insert_special_character_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_insert_special_character()
  {
    ...
    RadiobuttonDialog dialog("Insert character", "Insert special character",
        descriptions, settings->session.special_character_selection);
    if (dialog.run() != GTK_RESPONSE_OK)
      return;
...
void MainWindow::on_preferences_graphical_interface_activate(
    GtkMenuItem *menuitem, gpointer user_data)
  {
...
void MainWindow::check_move_new_reference()
  {
    Reference reference(keytermsgui->new_reference_showing->book,
        keytermsgui->new_reference_showing->chapter,
        keytermsgui->new_reference_showing->verse);
    navigation.display(reference);
  }

void MainWindow::on_view_keyterms_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_window_show_keyterms_button_clicked(GtkButton *button,
    gpointer user_data)
  {
...
void MainWindow::on_project_backup_incremental_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_project_backup_flexible_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_view_git_tasks_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_preferences_remote_git_repository_activate(
    GtkMenuItem *menuitem, gpointer user_data)
  {
...
void MainWindow::on_project_changes_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_edit_revert_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::git_update_intervals_initialize()
  {
    ...
    for (unsigned int i = 0; i < projects.size(); i++)
      {
        ProjectConfiguration * projectconfig =
            settings->projectconfig(projects[i]);
    ...
    // Start the timer.
    git_update_interval_event_id
        = g_timeout_add_full(G_PRIORITY_DEFAULT, 1000, GSourceFunc (on_git_update_timeout), gpointer(this), NULL);
  }
            ...
            if (interval >= projectconfig->git_remote_update_interval_get())
              {
                git_schedule(gttUpdateProject, projects[i], 0, 0,
                    projectconfig->git_remote_repository_url_get());
                interval = 0;
              }
...
void MainWindow::on_view_text_font_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_text_font()
  {
    ...
    unsigned int normaltextcolour =
        settings->genconfig.text_editor_normal_text_color_get();
    unsigned int backgroundcolour =
        settings->genconfig.text_editor_background_color_get();
    unsigned int selectedtextcolour =
        settings->genconfig.text_editor_selected_text_color_get();
    unsigned int selectioncolour =
        settings->genconfig.text_editor_selection_color_get();
    Editor * editor = editorsgui->focused_editor();
    if (editor)
      {
        ProjectConfiguration * projectconfig =
            settings->projectconfig(editor->project);
    ...
    FontColorDialog
        dialog(defaultfont, fontname, linespacing, defaultcolour,
            normaltextcolour, backgroundcolour, selectedtextcolour,
            selectioncolour);
    if (dialog.run() != GTK_RESPONSE_OK)
      return;
...
void MainWindow::on_view_notes_font_activate(GtkMenuItem * menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_notes_font()
  {
    ...
    FontColorDialog dialog(settings->genconfig.notes_editor_font_default_get(),
        settings->genconfig.notes_editor_font_name_get(), 100,
                ...
                if (convert_to_int(task[0]) == gttUpdateProject)
                  {
                    if (task[1] == settings->genconfig.project_get())
                      {
                        gitchapterstate
                            = new GitChapterState (task[1], navigation.reference.book, navigation.reference.chapter);
                      }
                  }
              }
          }
...
void MainWindow::on_preferences_reporting_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_editstatus_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
// Edits the project's status.
  {
    extern Settings * settings;
    EditStatusDialog dialog(settings->genconfig.project_get(),
        navigation.reference.book, navigation.reference.chapter);
    dialog.run();
  }

void MainWindow::on_view_status_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_edit_planning_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_view_planning_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_preferences_planning_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_file_resources_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_file_resources_open_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_file_resources_close_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_file_resources_new_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_file_resources_edit_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_file_resources_delete_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_editorsgui_focus_button_clicked(GtkButton *button,
    gpointer user_data)
  {
...
void MainWindow::on_editorsgui_focus_button()
  {
    ...
    Reference reference(settings->genconfig.book_get(),
        convert_to_int(settings->genconfig.chapter_get()),
...
void MainWindow::on_editorsgui_changed_clicked(GtkButton *button,
    gpointer user_data)
  {
...
void MainWindow::on_file_projects_merge_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_mergegui_get_text_button_clicked(GtkButton *button,
    gpointer user_data)
  {
...
void MainWindow::on_mergegui_get_text_button()
  {
    mergegui->main_project_data
        = editorsgui->get_text(mergegui->current_master_project);
    mergegui->edited_project_data
        = editorsgui->get_text(mergegui->current_edited_project);
    mergegui->book = navigation.reference.book;
    mergegui->chapter = navigation.reference.chapter;
  }

void MainWindow::on_mergegui_new_reference_button_clicked(GtkButton *button,
    gpointer user_data)
  {
...
void MainWindow::on_mergegui_save_editors_button_clicked(GtkButton *button,
    gpointer user_data)
  {
...
void MainWindow::on_preferences_filters_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
    ...
    case 2: // References.
      {
        ...
        if (refs.empty())
        ...
        else
          {
            ...
            ProjectMemory
                projectmemory(settings->genconfig.project_get(), true);
            view_parallel_references_pdf(projectmemory, &extra_projects, refs,
                true, NULL, true);
          }
        break;
      }
    case 3: // Tes
      {
        ...
        text2pdf.add_text("Some text above the picture.");
        text2pdf.display_picture(gw_build_filename(
            directories_get_package_data(), "biblesociety.png"));
        ...
        /*
         ...
         text2pdf.open_paragraph();
         text2pdf.add_text("Testament");
         text2pdf.open_paragraph();
         text2pdf.add_text("New Testament");
         text2pdf.new_page(false);
         text2pdf.open_paragraph();
...
void MainWindow::on_view_screen_layout_activate(GtkMenuItem *menuitem,
    gpointer user_data)
  {
...
void MainWindow::on_window_screen_layout_button_clicked(GtkButton *button,
    gpointer user_data)
  {
...
bool MainWindow::on_windows_startup()
  {
    ...
    if (windows_startup_pointer < window_ids.size())
      {
        WindowID id = WindowID(window_ids[windows_startup_pointer]);
        switch (id)
          {
...
// Shut any open windows down.
  {
    ...
    vector<int> open_window_ids = settings->genconfig.window_ids_get();
    ...
    // Store the list of open windows.
    settings->genconfig.window_ids_set(open_window_ids);
