...
void MainWindow::on_print() {
  ...
  switch (selection)
  {
    ...
    case 3: // Test text2pdf Todo
    {
      ...
      text2pdf.add_text(" ");
      text2pdf.inline_set_font_size_percentage(120);
      text2pdf.add_text("An");
      text2pdf.inline_set_font_size_percentage(100);
      text2pdf.add_text("d he said: ");
      ...
      text2pdf.add_text("I love you because we follow the truth, dear friend.");
      text2pdf.add_text(" ");
      text2pdf.inline_set_italic(t2pmtOn);
      text2pdf.add_text("Some italics text.");
      ...
      */
      ...
      text2pdf.add_text("off ");
      text2pdf.inline_set_italic(t2pmtInherit);
      text2pdf.add_text("inherit ");
      text2pdf.inline_set_italic(t2pmtToggle);
      text2pdf.add_text("toggle ");
      text2pdf.inline_clear_italic();
      text2pdf.add_text("clear ");
      text2pdf.inline_set_bold(t2pmtToggle);
      text2pdf.add_text("bold ");
