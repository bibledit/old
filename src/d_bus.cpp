...
{
  switch (dbname) {
    case dbntNone:                  return NULL;
    case dbntOrgBibleditBin:        return "org.bibledit.bin";
    case dbntOrgBibleditBibletime:  return "org.bibledit.bibletime";
    case dbntOrgBibleditGit:        return "org.bibledit.git";
  }
  return NULL;
}
...
{
  switch (dbmethod) {
    case dbmtHello: return "Hello";
    case dbmtEnd: return NULL;
  }
  return NULL;
}
