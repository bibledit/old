...
void OpenDocument::generate_styles (xmlTextWriterPtr writer)
{
  ...
  for (unsigned int i = 0; i < usfm->styles.size(); i++) {
    ...
    if (usfm->is_starting_paragraph (marker)) {
      paragraph_style (writer, marker, usfm->name (), fontname,
...
void OpenDocument::paragraph_style (xmlTextWriterPtr writer,
                                    const ustring& marker, const ustring& name,
...
void OpenDocument::span_style (xmlTextWriterPtr writer,
                   const ustring& marker, const ustring& name,
                   const ustring& fontname,
                   double fontpercentage, ustring italic, ustring bold, 
                   ustring underline, ustring smallcaps, bool superscript,
                   unsigned int color)
{
  // Open the style.
  xmlTextWriterStartElement (writer, BAD_CAST "style:style");
  {
    ...
    xmlTextWriterStartElement (writer, BAD_CAST "style:text-properties");
    {
      ...
      if ((italic == ON) || (italic == TOGGLE)) italic = "italic";
      else italic = "normal";
      ...
      if ((bold == ON) || (bold == TOGGLE)) bold = "bold";
      else bold = "normal";
      ...
      if ((underline == ON) || (underline == TOGGLE)) underline = "solid";
      else underline = "none";
      xmlTextWriterWriteAttribute (writer, BAD_CAST "style:text-underline-style", BAD_CAST underline.c_str());
      xmlTextWriterWriteAttribute (writer, BAD_CAST "style:text-underline-width", BAD_CAST "auto");
      xmlTextWriterWriteAttribute (writer, BAD_CAST "style:text-underline-color", BAD_CAST "font-color");
      if ((smallcaps == ON) || (smallcaps == TOGGLE)) smallcaps = "small-caps";
      else smallcaps = "normal";
