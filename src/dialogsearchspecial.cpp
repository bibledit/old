...
SearchSpecialDialog::SearchSpecialDialog (BibleTime * bibletime)
{
  ...
  gtk_widget_add_accelerator (searchspecialdialog, "activate_focus", accel_group,
  ...
  gtk_table_attach (GTK_TABLE (table2), button_books, 0, 1, 0, 1,
  ...
  gtk_table_attach (GTK_TABLE (table2), button_area, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table2), label_book, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
  ...
  gtk_table_attach (GTK_TABLE (table2), label_area, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 2, 0);
  ...
  gtk_table_attach (GTK_TABLE (table1), radiobutton_bt_bible, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table1), radiobutton_bt_commentary, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table1), combobox_bt_bibles, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);

  combobox_bt_commentaries = gtk_combo_box_new_text (); // Modified
  gtk_widget_show (combobox_bt_commentaries);
  gtk_table_attach (GTK_TABLE (table1), combobox_bt_commentaries, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  ...
  new InDialogHelp (searchspecialdialog, NULL, NULL);
...
void SearchSpecialDialog::on_find ()
{
  ...
  switch (settings->session.searchresultstype) {
    case sstLoad: settings->session.highlights.clear(); // Fall through, all the way to the bottom.
    case sstAdd:
    case sstSubtract:
    case sstShare: {
      SessionHighlights sessionhighlights (settings->session.searchword, 
                                           ...
                                           settings->session.search_end_word_match,
                                           settings->session.area_type, 
...
void SearchSpecialDialog::on_activate ()
{
  ...
  if (!GTK_WIDGET_SENSITIVE (findbutton)) return;
  if (allow_activate) {
    on_find ();
