...
void NotesUpdateDialog::on_ok ()
{
  ...
  switch (page) {
    ...
    {
      // Change project.
      notes_change_project (combobox_get_active_string (combobox_project_from), 
                            combobox_get_active_string (combobox_project_to));
    ...
    {
      // Change category.
      notes_change_category (combobox_get_active_string (combobox_category_from), 
                             combobox_get_active_string (combobox_category_to));
