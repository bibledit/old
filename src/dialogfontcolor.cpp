...
FontColorDialog::FontColorDialog (bool initial_use_default_font, 
                                  ...
                                  unsigned int initial_selection_color)
{
  ...
  dialog_vbox1 = GTK_DIALOG (fontcolordialog)->vbox;
  ...
  gtk_table_attach (GTK_TABLE (table1), colorbutton_normal_text, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  colorbutton_background = gtk_color_button_new ();
  gtk_widget_show (colorbutton_background);
  gtk_table_attach (GTK_TABLE (table1), colorbutton_background, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  colorbutton_selected_text = gtk_color_button_new ();
  gtk_widget_show (colorbutton_selected_text);
  gtk_table_attach (GTK_TABLE (table1), colorbutton_selected_text, 1, 2, 2, 3,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  colorbutton_selection = gtk_color_button_new ();
  gtk_widget_show (colorbutton_selection);
  gtk_table_attach (GTK_TABLE (table1), colorbutton_selection, 1, 2, 3, 4,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  dialog_action_area1 = GTK_DIALOG (fontcolordialog)->action_area;
  gtk_widget_show (dialog_action_area1);
  gtk_button_box_set_layout (GTK_BUTTON_BOX (dialog_action_area1), GTK_BUTTONBOX_END);

  new InDialogHelp (fontcolordialog, &shortcuts, NULL);
