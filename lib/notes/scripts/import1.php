...
<p><?php echo gettext("Bibledit-Gtk, part of the Bibledit Suite, has what it calls Project Notes. These can be imported into Bibledit, and will appear there as Consultation Notes.") ?></p>
<p><?php echo gettext("When doing this import, it is important to know that this is a one-way operation. It means that, at the time of writing this, notes can be moved from Bibledit-Gtk to Bibledit, but not the other way round.") ?></p>
<p><?php echo gettext("Importing the notes into Bibledit, and using these there, has some advantages. For example, users can be notified of changes in the notes.") ?></p>
<br>
<p><?php echo gettext("Have you decided that you'd like to move your notes from Bibledit-Gtk to Bibledit? Let's give it a go, then.") ?></p>
<br>
...
<p><?php echo gettext("The configuration of the server on which Bibledit runs imposes some limits on the size of the file to be uploaded. The size of the file should not exceed either of the two limits given below:") ?></p>
...
<br>
<p><?php echo gettext("The next thing is to upload this file to Bibledit.") ?></p>
