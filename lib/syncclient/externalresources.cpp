...
int syncclient_externalresources_watchdog = 0;


void syncclient_externalresources_done ()
{
  syncclient_externalresources_watchdog = 0;
}


string syncclient_externalresources_text ()
{
  return translate("External resources") + ": ";
}


string syncclient_externalresources_sendreceive_text ()
{
  return syncclient_externalresources_text () + translate ("Synchronizing");
}


string syncclient_externalresources_up_to_date_text ()
{
  return syncclient_externalresources_text () + translate ("Up to date");
}


void syncclient_externalresources ()
{
  if (syncclient_externalresources_watchdog) {
    int time = filter_date_seconds_since_epoch ();
    if (time < (syncclient_externalresources_watchdog + 900)) {
      Database_Logs::log (syncclient_externalresources_text () + translate("Still busy"), Filter_Roles::translator ());
      return;
    }
    Database_Logs::log (syncclient_externalresources_text () + translate("Watchdog timeout"), Filter_Roles::translator ());
  }
  syncclient_externalresources_kick_watchdog ();
  ...
  Database_Logs::log (syncclient_externalresources_sendreceive_text (), Filter_Roles::translator ());
  ...
  if (!error.empty ()) {
    Database_Logs::log (syncclient_externalresources_text () + "Failure requesting checksum: " + error, Filter_Roles::translator ());
    syncclient_externalresources_done ();
    return;
  }
  string checksum = Sync_Logic::offline_resources_checksum ();
  if (response == checksum) {
    Database_Logs::log (syncclient_externalresources_up_to_date_text (), Filter_Roles::translator ());
    syncclient_externalresources_done ();
    return;
  }
  ...
  response = sync_logic.post (post, url, error);
  if (!error.empty ()) {
    Database_Logs::log (syncclient_externalresources_text () + "Failure requesting names: " + error, Filter_Roles::translator ());
    syncclient_externalresources_done ();
    return;
  }
  ...
  for (auto & resource : server_resources) {
    ...
    response = sync_logic.post (post, url, error);
    if (!error.empty ()) {
      Database_Logs::log (syncclient_externalresources_text () + "Failure requesting files: " + error, Filter_Roles::translator ());
      syncclient_externalresources_done ();
      return;
    }
    ...
    for (auto & file : server_files) {
      ...
      response = sync_logic.post (post, url, error);
      if (!error.empty ()) {
        Database_Logs::log (syncclient_externalresources_text () + "Failure requesting checksum file: " + error, Filter_Roles::translator ());
        syncclient_externalresources_done ();
        return;
      }
      ...
      Database_Logs::log (syncclient_externalresources_text () + "Downloading " + resource + " " + file, Filter_Roles::translator ());
      ...
      response = sync_logic.post (post, url, error);
      if (!error.empty ()) {
        Database_Logs::log (syncclient_externalresources_text () + "Failure downloading file: " + error, Filter_Roles::translator ());
        syncclient_externalresources_done ();
        return;
      }
  ...
  // Done.
  Database_Logs::log (syncclient_externalresources_text () + "Now up to date", Filter_Roles::translator ());
  syncclient_externalresources_done ();
}


void syncclient_externalresources_kick_watchdog ()
{
  syncclient_externalresources_watchdog = filter_date_seconds_since_epoch ();
}
