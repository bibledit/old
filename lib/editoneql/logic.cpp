...
void editoneql_logic_suffix_html (string editable_last_p_style, string usfm, string stylesheet, string & html)
{
  if (!usfm.empty ()) {
    Editor_Usfm2Html editor_usfm2html;
    editor_usfm2html.load (usfm);
...
void editoneql_logic_move_notes (string & prefix, string & suffix)
{
  // No input: Ready.
