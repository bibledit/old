...
function oneverseEditorLoadVerse () // Todo update for Quill.
{
      ...
      success: function (response) {
        ...
        if (response !== false) {
          ...
          */
          ...
          // The browser may reformat the loaded html, so take the possible reformatted data for reference. Todo
...
function visualVerseEditorTextChangeHandler (delta, oldContents, source) // Todo implement.
{
}
