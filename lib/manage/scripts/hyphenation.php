...
<br>
<p><?php echo gettext("The Bible where the data will be taken from is:") ?> <a href="?bible="><?php echo $this->bible ?></a></p>
<p><?php echo gettext("The Bible where the hyphenated data will be written to is:") ?> <?php echo $this->bible ?>-hyphenated</p>
<br>
<p><a href="?run="><?php echo gettext("Insert the soft hyphens according to the settings.") ?></a></p>
