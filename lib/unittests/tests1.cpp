...
void test_database_styles ()
{
  ...
  }
  {
    ...
    evaluate (__LINE__, __func__, markers, markers_names ["marker"]);
    ...
    evaluate (__LINE__, __func__, "Normal, First Line Indent", name);
    ...
    evaluate (__LINE__, __func__, "* Translational Addition", name);
    ...
    marker = "p";
    iter = find (markers_names ["marker"].begin (), markers_names ["marker"].end (), marker);
    if (iter != markers_names ["marker"].end ()) evaluate (__LINE__, __func__, marker, "should not be there");
  ...
  }
  {
    ...
    evaluate (__LINE__, __func__, filter_string_trim (standard), filter_string_trim (xml));
  }
  {
    refresh_sandbox (true);
    Database_Styles database_styles = Database_Styles ();
