...
function navigatePreviousVerse (event) { // Todo respond to swipe, and cross chapter boundary.
  event.preventDefault ();
  $.ajax ({
    url: "/navigation/update",
    type: "GET",
...
function navigateNextVerse (event) { // Todo respond to swipe, and cross chapter boundary.
  event.preventDefault ();
  $.ajax ({
    url: "/navigation/update",
    type: "GET",
...
function navigatePreviousChapter (event) { // Todo respond to swipe, and cross book boundary.
  event.preventDefault ();
  $.ajax ({
    url: "/navigation/update",
    type: "GET",
...
function navigateNextChapter (event) { // Todo respond to swipe, and cross chapter boundary.
  event.preventDefault ();
  $.ajax ({
    url: "/navigation/update",
    type: "GET",
