...
function navigatePreviousVerse (event) { // Todo cross chapter boundary.
  event.preventDefault ();
  $.ajax ({
    url: "/navigation/update",
    type: "GET",
...
function navigateNextVerse (event) { // Todo cross chapter boundary.
  event.preventDefault ();
  $.ajax ({
    url: "/navigation/update",
    type: "GET",
...
function navigatePreviousChapter (event) { // Todo cross book boundary.
  event.preventDefault ();
  $.ajax ({
    url: "/navigation/update",
    type: "GET",
...
function navigateNextChapter (event) { // Todo cross chapter boundary.
  event.preventDefault ();
  $.ajax ({
    url: "/navigation/update",
    type: "GET",
