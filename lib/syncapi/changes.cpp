...
string syncapi_changes_url ()
{
  return "syncapi/changes";
}


bool syncapi_changes_acl (void * webserver_request)
{
  return Filter_Roles::access_control (webserver_request, Filter_Roles::guest ());
}


string syncapi_changes (void * webserver_request)
{
  ...
  switch (action) {
    case SyncAPI_Logic::changes_delete_modification:
    {
    ...
    case SyncAPI_Logic::changes_get_checksum:
    {
      ...
      if (checksum.empty ()) {
        checksum = SyncAPI_Logic::changes_checksum (user);
        request->database_config_user ()->setChangeNotificationsChecksum (checksum);
      }
      return checksum;
    }
    case SyncAPI_Logic::changes_get_identifiers:
    {
    ...
    case SyncAPI_Logic::changes_get_modification:
    {
