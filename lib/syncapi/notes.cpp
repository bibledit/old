...
string syncapi_notes_url ()
{
  return "syncapi/notes";
}


bool syncapi_notes_acl (void * webserver_request)
{
  return Filter_Roles::access_control (webserver_request, Filter_Roles::guest ());
}


string syncapi_notes (void * webserver_request)
{
  ...
  if (action >= SyncAPI_Logic::notes_put_create_initiate) {
  ...
  if ((action == SyncAPI_Logic::notes_get_total) || (action == SyncAPI_Logic::notes_get_identifiers)) {
  ...
  switch (action) {
    case SyncAPI_Logic::notes_get_total:
    {
    ...
    case SyncAPI_Logic::notes_get_identifiers:
    {
      vector <string> bibles = access_bible_bibles (webserver_request, user);
      vector <int> identifiers = database_notes.getNotesInRangeForBibles (lowId, highId, bibles, false);
      string response;
    ...
    case SyncAPI_Logic::notes_get_summary:
    {
    ...
    case SyncAPI_Logic::notes_put_create_complete:
    {
      // Do notifications.
    ...
    case SyncAPI_Logic::notes_put_summary:
    {
    ...
    case SyncAPI_Logic::notes_put_contents:
    {
    ...
    case SyncAPI_Logic::notes_put_comment:
    {
    ...
    case SyncAPI_Logic::notes_put_subscribe:
    {
    ...
    case SyncAPI_Logic::notes_put_unsubscribe:
    {
    ...
    case SyncAPI_Logic::notes_put_assign:
    {
    ...
    case SyncAPI_Logic::notes_put_unassign:
    {
    ...
    case SyncAPI_Logic::notes_put_status:
    {
    ...
    case SyncAPI_Logic::notes_put_passages:
    {
    ...
    case SyncAPI_Logic::notes_put_severity:
    {
    ...
    case SyncAPI_Logic::notes_put_bible:
    {
    ...
    case SyncAPI_Logic::notes_put_mark_delete:
    {
    ...
    case SyncAPI_Logic::notes_put_unmark_delete:
    {
    ...
    case SyncAPI_Logic::notes_put_delete:
    {
