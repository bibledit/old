...
string syncapi_bibles_url ()
{
  return "syncapi/bibles";
}


bool syncapi_bibles_acl (void * webserver_request)
{
  return Filter_Roles::access_control (webserver_request, Filter_Roles::guest ());
}


string syncapi_bibles_receive_chapter (Webserver_Request * request, string & bible, int book, int chapter)
{
...
string syncapi_bibles (void * webserver_request)
{
  ...
  switch (action) {
    case SyncAPI_Logic::bibles_get_total_checksum:
    {
    ...
    case SyncAPI_Logic::bibles_get_bibles:
    {
      // The server reads the credentials from the client's user,
    ...
    case SyncAPI_Logic::bibles_get_chapter_checksum:
    {
      // The server responds with the checksum of the whole chapter.
      return Checksum_Logic::getChapter (request, bible, book, chapter);
    }
    case SyncAPI_Logic::bibles_send_chapter:
    {
      return syncapi_bibles_receive_chapter (request, bible, book, chapter);
    }
    case SyncAPI_Logic::bibles_get_chapter:
    {
