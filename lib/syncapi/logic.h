...
#ifndef INCLUDED_SYNCAPI_LOGIC_H
#define INCLUDED_SYNCAPI_LOGIC_H
...
{
public:
  SyncAPI_Logic (void * webserver_request_in);
  ~SyncAPI_Logic ();
  ...
  vector <SyncAPI_Logic_Range> create_range (int start, int end);
