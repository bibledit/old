...
<h2><?php echo gettext("Scripting") ?></h2>
<p>
  <?php echo gettext("Here is a sample script.") ?>
  <?php echo gettext("It runs in InDesign.") ?>
  <?php echo gettext("It shows how to replace text, and how to update the formatting.") ?>
</p>
<pre>
