...
*/
?>
<h2><?php echo gettext("Install Bibledit-Web 1.7 on Ubuntu 14.04") ?></h2>
<p>
...
<li>
  <p><?php echo gettext("Start installing the web server:") ?></p>
  <p><code>$ sudo apt-get install tasksel</code></p>
  <p><code>$ sudo tasksel</code></p>
</li>
<li><?php echo gettext("Enable the LAMP server, and install.") ?></li>
<li>
  <?php echo gettext("Test the web server by opening the site in the browser, for example:") ?>
  http://localhost
  <?php echo gettext("or") ?>
  http://website.org.
  <?php echo gettext("When the web server works, the browser displays the default Apache page.") ?>
</li>
<li>
  <p><?php echo gettext("Remove the MySQL server as it is not needed and to save memory:") ?></p>
...
<li>
  ...
  <p><code>$ sudo apt-get install git unzip libzend-framework-php rcs php5-json php5-sqlite</code></p>
</li>
<li>
  <p><?php echo gettext("Reload the Apache web server so that the new modules take effect:") ?></p>
  <p><code>$ sudo service apache2 reload</code></p>
</li>
<li>
  <p><?php echo gettext("Download Bibledit-Web:") ?></p>
  <p><code>$ sudo wget http://download.savannah.nongnu.org/releases/bibledit-web/source/bibledit-web-1.7.zip</code></p>
</li>
<li>
  <p><?php echo gettext("Install Bibledit-Web in folder /var/www/html as user root:") ?></p>
  <p><code>$ cd /var/www/html</code></p>
  <p><code>$ sudo unzip ~/bibledit-web-1.7.zip</code></p>
</li>
<li>
