...
*/
?>
<h1><?php echo Locale_Translate::_("Install Bibledit-Web 1.8 on Mac OS X") ?></h1>
<p>
...
<li>
<p>
  <a href="http://download.savannah.nongnu.org/releases/bibledit-web/source/bibledit-web-1.8.zip" target="_blank"><?php echo Locale_Translate::_("Download") ?> Bibledit-Web 1.8</a>.
</p>
</li>
