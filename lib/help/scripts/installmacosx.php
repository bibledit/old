...
*/
?>
<h1><?php echo gettext("Install Bibledit-Web 1.8 on Mac OS X") ?></h1>
<p>
  <?php echo gettext("This assumes a standard installation of the operating system.") ?>
  <?php echo gettext("Bibledit-Web runs on all recent versions of Mac OS X.") ?>
...
<li>
<p>
  <a href="http://download.savannah.nongnu.org/releases/bibledit-web/source/bibledit-web-1.8.zip" target="_blank"><?php echo gettext("Download") ?> Bibledit-Web 1.8</a>.
</p>
</li>

<li>
<p><?php echo gettext("Unzip Bibledit-Web into this folder:") ?> <code>/opt/local/apache2/htdocs</code></p>
</li>
...
<li>
<p>
  <?php echo gettext("To configure Bibledit-Web, point your browser to:") ?>
...
<li>
<p>
  <?php echo gettext("To use Bibledit-Web, point your browser to the same address:") ?>
  <a href="http://localhost/bibledit-web" target="_blank">​http://localhost/bibledit-web</a>.
</p>
</li>
