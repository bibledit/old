...
*/
?>
<h1>translate("Verse mappings") $this->name</h1>
...
<p>
  translate("It means that Genesis 31:55 in this verse mapping matches with Genesis 31:1 in the original Bible text.")
  translate("If this is the English verse mapping, it means that Genesis 31:55 in Bibles with the English versification system matches with Genesis 31:1 in Hebrew Bibles.")
  translate("The same applies to verse mappings for the New Testament.")
  translate("In short: At the left side of the equation sign is the passage in your Bible.")
