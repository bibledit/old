...
$ (document).ready (function () 
{
  ...
  if (swipe_operations) $ ("body").on ("swipeleft", editorSwipeLeft);
  if (swipe_operations) $ ("body").on ("swiperight", editorSwipeRight);
});
...
function editorLoadChapter (reload)
{
  ...
  $.ajax ({
    ...
    success: function (response) {
      if (response == "switch") {
        // Open the visual verse editor.
        window.location.href = "../editone/index";
        return;
      }
