...
Dialog_List::Dialog_List (const string& url, map <string, string> query, const string& question, const string& value, const string& submit, const string& help) // Todo porting this one.
{
