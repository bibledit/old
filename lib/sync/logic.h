...
public:
  ...
  static const int notes_put_create = 12;
  static const int notes_put_summary = 13;
  static const int notes_put_contents = 14;
  static const int notes_put_comment = 15;
  static const int notes_put_subscribe = 16;
  static const int notes_put_unsubscribe = 17;
  static const int notes_put_assign = 18;
  static const int notes_put_unassign = 19;
  static const int notes_put_status = 20;
  static const int notes_put_passages = 21;
  static const int notes_put_severity = 22;
  static const int notes_put_bible = 23;
  static const int notes_put_mark_delete = 24;
  static const int notes_put_unmark_delete = 25;
  static const int notes_put_delete = 26;
