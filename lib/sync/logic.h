...
public:
  ...
  static const int notes_put_create = 12; // Todo
  static const int notes_put_summary = 13;
  static const int notes_put_contents = 14;
  static const int notes_put_subscribers = 15;
  static const int notes_put_assignees = 16;
  static const int notes_put_status = 17;
  static const int notes_put_passages = 18;
  static const int notes_put_severity = 19;
  static const int notes_put_bible = 20;
  static const int notes_put_modified = 21;
