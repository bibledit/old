...
string editoneold_load_url ()
{
  return "editoneold/load";
}


bool editoneold_load_acl (void * webserver_request)
{
...
string editoneold_load (void * webserver_request)
{
  ...
  string prefix_usfm = usfm_get_verse_range_text (chapter_usfm, 0, verse - 1, editable_usfm, false);
  string suffix_usfm = usfm_get_verse_range_text (chapter_usfm, verse + 1, highest_verse, editable_usfm, false);
