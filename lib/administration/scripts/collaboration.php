...
<p><?php echo gettext("With distributed collaboration there are several copies of the Bible distributed all over the place or the globe.") ?></p>
...
<?php if (!$this->git_available) { ?>
  <div class="error">
    <?php echo gettext("Program 'git' cannot be found.") ?>
    <?php echo gettext("It is necessary for distributed collaboration.") ?>
    <?php echo gettext("Install it, then proceed.") ?>
  </div>
<?php } ?>
