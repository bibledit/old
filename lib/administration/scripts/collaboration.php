...
<p>gettext("If distributed collaboration is used, it needs to be set up per Bible.") <a href="collaboration.php?object=$this->object&select">gettext ("Select which Bible to use.")</a></p>
<?php if ($this->object != "") {
  <p>gettext("Setup for Bible"): $this->object</p>
  <?php if ($this->url != "") {
  <p>gettext("Distributed collaboration for this is enabled.") <a href="collaboration.php?object=$this->object&disable=">gettext ("Disable it.")</a></p>
  <?php }
  ...
  <ul>
    <li>
      ...
      <a href="collaboration_flash_drive_setup.php?object=$this->object">gettext("Set it up.")</a>
    </li>
    <li>
      ...
      <a href="collaboration_open_network_setup.php?object=$this->object">gettext("Set it up.")</a>
    </li>
    <li>
      ...
      <a href="collaboration_password_protected_network_setup.php?object=$this->object">gettext("Set it up.")</a>
    </li>
    <li>
      ...
      <a href="collaboration_secure_network_setup.php?object=$this->object">gettext("Set it up.")</a>
    </li>
  </ul>
<?php }
