...
?>
<div>
  <?php echo Locale_Translate::_("Search for verses with similar Hebrew or Greek in:") ?>
  <?php echo $this->bible; ?>
  |
...
<script type="text/javascript" src="originals.js?<?php echo Config_Logic::version () ?>"></script>
