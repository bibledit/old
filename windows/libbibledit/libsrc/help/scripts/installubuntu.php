...
*/
?>
<h2><?php echo Locale_Translate::_("Install Bibledit-Web 1.7 on Ubuntu 14.04") ?></h2>
<p>
...
<li>
  <p><?php echo Locale_Translate::_("Remove the MySQL server as it is not needed and to save memory:") ?></p>
