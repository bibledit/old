...
OBJEXT = o
PACKAGE = bibledit
PACKAGE_BUGREPORT = http://bibledit.sourceforge.net
PACKAGE_CFLAGS =  
PACKAGE_LIBS = -lfontconfig  
PACKAGE_NAME = bibledit
PACKAGE_STRING = bibledit 3.0.37
...
target_os = linux-gnu
target_vendor = pc
SUBDIRS = man pix doc src scripts templates vacuum olpc desktop windows tests
